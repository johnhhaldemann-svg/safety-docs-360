...
-- "extensions"."vector" type (pgvector). Matches the archived migrations, which
-- created `pgcrypto` and `vector`.
...
ALTER TYPE "public"."gus_answer_feedback_type" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_knowledge_change_type" OWNER TO "postgres";


CREATE TYPE "public"."gus_knowledge_review_status" AS ENUM (
    'current',
    'needs_review',
    'archived'
);
...
ALTER TYPE "public"."gus_knowledge_review_status" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_learning_review_item_status" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_learning_review_item_type" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_learning_source_type" OWNER TO "postgres";


CREATE TYPE "public"."gus_learning_trust_level" AS ENUM (
    'high',
    'medium',
    'low',
    'blocked'
...
ALTER TYPE "public"."gus_learning_trust_level" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_required_control_type" OWNER TO "postgres";
...
ALTER TYPE "public"."gus_research_status" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."match_approved_knowledge"("p_company_id" "uuid", "p_project_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer DEFAULT 8) RETURNS TABLE("id" "uuid", "company_id" "uuid", "project_id" "uuid", "approved_source_id" "uuid", "research_queue_id" "uuid", "topic" "text", "knowledge_title" "text", "approved_summary" "text", "source_url" "text", "source_title" "text", "source_type" "public"."gus_learning_source_type", "jurisdiction" "text", "regulation_reference" "text", "applies_to" "text", "affected_modules" "text"[], "required_control_type" "public"."gus_required_control_type", "citation_excerpt" "text", "citation_locator" "text", "source_content_hash" "text", "verification_notes" "text", "quality_score" numeric, "supersedes_knowledge_id" "uuid", "superseded_by_knowledge_id" "uuid", "approved_by" "uuid", "approved_at" timestamp with time zone, "review_due_date" "date", "review_status" "public"."gus_knowledge_review_status", "version" integer, "is_active" boolean, "created_at" timestamp with time zone, "updated_at" timestamp with time zone, "similarity" double precision)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."match_approved_knowledge"("p_company_id" "uuid", "p_project_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."match_company_memory_items"("p_company_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer DEFAULT 8) RETURNS TABLE("id" "uuid", "company_id" "uuid", "source" "text", "title" "text", "body" "text", "metadata" "jsonb", "created_by" "uuid", "created_at" timestamp with time zone, "updated_at" timestamp with time zone, "similarity" double precision)
    LANGUAGE "sql" STABLE
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."match_company_memory_items"("p_company_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."security_can_approve_gus_learning"("target_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."security_can_approve_gus_learning"("target_company_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."security_can_review_gus_learning"("target_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
  select
...
ALTER FUNCTION "public"."security_can_review_gus_learning"("target_company_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_engine_events" (
    ...
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_engine_events_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['system'::"text", 'user'::"text", 'ai'::"text"]))),
    CONSTRAINT "ai_engine_events_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_engine_events_type_nonempty" CHECK (("length"(TRIM(BOTH FROM "event_type")) > 0))
);


ALTER TABLE "public"."ai_engine_events" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_engine_events" IS 'Server-only. Written and read exclusively via service_role (API routes, cron jobs). RLS enabled with no client policies is intentional — blocks direct client access. Do not add permissive policies without security review.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_engine_validation_logs" (
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_engine_validation_logs_action_nonempty" CHECK (("length"(TRIM(BOTH FROM "validation_action")) > 0)),
    CONSTRAINT "ai_engine_validation_logs_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_engine_validation_logs_target_check" CHECK (("target_type" = ANY (ARRAY['node'::"text", 'edge'::"text", 'index'::"text", 'source_record'::"text"])))
);


ALTER TABLE "public"."ai_engine_validation_logs" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_engine_validation_logs" IS 'Server-only. Written and read exclusively via service_role (superadmin AI Engine routes). RLS enabled with no client policies is intentional — blocks direct client access. Do not add permissive policies without security review.';



CREATE TABLE IF NOT EXISTS "public"."ai_improvement_audit_events" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "improvement_request_id" "uuid",
    "actor_id" "uuid",
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_improvement_audit_events_actor_type_check" CHECK (("actor_type" = ANY (ARRAY['user'::"text", 'ai'::"text", 'system'::"text"]))),
    CONSTRAINT "ai_improvement_audit_events_event_type_check" CHECK (("event_type" = ANY (ARRAY['ai_improvement_request_created'::"text", 'ai_improvement_request_updated'::"text", 'codex_branch_linked'::"text", 'pull_request_linked'::"text", 'tests_completed'::"text", 'approval_requested'::"text", 'super_admin_approved'::"text", 'super_admin_rejected'::"text", 'unauthorized_approval_attempt'::"text", 'deployment_triggered'::"text", 'rollback_triggered'::"text"]))),
    CONSTRAINT "ai_improvement_audit_events_new_status_check" CHECK ((("new_status" IS NULL) OR ("new_status" = ANY (ARRAY['draft'::"text", 'proposed'::"text", 'in_progress'::"text", 'awaiting_super_admin_approval'::"text", 'approved'::"text", 'rejected'::"text", 'merged'::"text", 'deployed'::"text", 'failed'::"text", 'rolled_back'::"text"])))),
    CONSTRAINT "ai_improvement_audit_events_status_check" CHECK ((("old_status" IS NULL) OR ("old_status" = ANY (ARRAY['draft'::"text", 'proposed'::"text", 'in_progress'::"text", 'awaiting_super_admin_approval'::"text", 'approved'::"text", 'rejected'::"text", 'merged'::"text", 'deployed'::"text", 'failed'::"text", 'rolled_back'::"text"]))))
);


ALTER TABLE "public"."ai_improvement_audit_events" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_improvement_requests" (
    ...
    "affected_area" "text" DEFAULT ''::"text" NOT NULL,
    "branch_name" "text",
    "pull_request_url" "text",
    "latest_commit_sha" "text",
    "test_summary" "text" DEFAULT ''::"text" NOT NULL,
    "codex_summary" "text" DEFAULT ''::"text" NOT NULL,
    "rollback_plan" "text" DEFAULT ''::"text" NOT NULL,
    "checks_passed" boolean DEFAULT false NOT NULL,
    "super_admin_override_reason" "text",
    "approved_by_super_admin_id" "uuid",
    "approved_at" timestamp with time zone,
    "rejected_by_super_admin_id" "uuid",
    "rejected_at" timestamp with time zone,
    "rejection_reason" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_improvement_requests_approval_requires_superadmin" CHECK ((("status" <> 'approved'::"text") OR (("approved_by_super_admin_id" IS NOT NULL) AND ("approved_at" IS NOT NULL) AND (("checks_passed" = true) OR ("length"(TRIM(BOTH FROM COALESCE("super_admin_override_reason", ''::"text"))) > 0))))),
    CONSTRAINT "ai_improvement_requests_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['user'::"text", 'ai'::"text", 'system'::"text"]))),
    CONSTRAINT "ai_improvement_requests_rejection_requires_reason" CHECK ((("status" <> 'rejected'::"text") OR (("rejected_by_super_admin_id" IS NOT NULL) AND ("rejected_at" IS NOT NULL) AND ("length"(TRIM(BOTH FROM COALESCE("rejection_reason", ''::"text"))) > 0)))),
    CONSTRAINT "ai_improvement_requests_risk_level_check" CHECK (("risk_level" = ANY (ARRAY['low'::"text", 'medium'::"text", 'high'::"text", 'critical'::"text"]))),
    CONSTRAINT "ai_improvement_requests_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'proposed'::"text", 'in_progress'::"text", 'awaiting_super_admin_approval'::"text", 'approved'::"text", 'rejected'::"text", 'merged'::"text", 'deployed'::"text", 'failed'::"text", 'rolled_back'::"text"]))),
    CONSTRAINT "ai_improvement_requests_title_not_blank" CHECK (("length"(TRIM(BOTH FROM "title")) > 0))
);


ALTER TABLE "public"."ai_improvement_requests" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_knowledge_edges" (
    ...
    "relationship_strength" numeric DEFAULT 0.5 NOT NULL,
    "strength_score" numeric DEFAULT 0.5 NOT NULL,
    "reason" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_knowledge_edges_confidence_range" CHECK ((("confidence_score" IS NULL) OR (("confidence_score" >= (0)::numeric) AND ("confidence_score" <= (1)::numeric)))),
    CONSTRAINT "ai_knowledge_edges_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['system'::"text", 'user'::"text", 'ai'::"text"]))),
    CONSTRAINT "ai_knowledge_edges_evidence_array" CHECK (("jsonb_typeof"("source_evidence") = 'array'::"text")),
    CONSTRAINT "ai_knowledge_edges_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_edges_not_self" CHECK ((("source_node_id" <> "target_node_id") AND ("from_node_id" <> "to_node_id"))),
    CONSTRAINT "ai_knowledge_edges_strength_range" CHECK ((("relationship_strength" >= (0)::numeric) AND ("relationship_strength" <= (1)::numeric) AND ("strength_score" >= (0)::numeric) AND ("strength_score" <= (1)::numeric))),
    CONSTRAINT "ai_knowledge_edges_validation_status_check" CHECK (("validation_status" = ANY (ARRAY['unreviewed'::"text", 'pending_review'::"text", 'approved'::"text", 'rejected'::"text", 'incorrect'::"text", 'needs_review'::"text"])))
);


ALTER TABLE "public"."ai_knowledge_edges" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_knowledge_edges" IS 'Server-only. Written via service_role AI knowledge ingest pipeline. RLS enabled with no client policies is intentional — blocks direct client access. Read access is exposed only through server-side safety intelligence API routes.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_knowledge_ingest_batches" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "company_id" "uuid",
    "batch_type" "text" DEFAULT 'rebuild_index'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_knowledge_ingest_batches_counts_object" CHECK ((("jsonb_typeof"("source_counts") = 'object'::"text") AND ("jsonb_typeof"("candidate_counts") = 'object'::"text"))),
    CONSTRAINT "ai_knowledge_ingest_batches_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['system'::"text", 'user'::"text", 'ai'::"text"]))),
    CONSTRAINT "ai_knowledge_ingest_batches_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_ingest_batches_status_check" CHECK (("status" = ANY (ARRAY['pending_review'::"text", 'partially_approved'::"text", 'approved'::"text", 'rejected'::"text", 'promoted'::"text", 'failed'::"text"]))),
    CONSTRAINT "ai_knowledge_ingest_batches_warnings_array" CHECK (("jsonb_typeof"("warnings") = 'array'::"text"))
);


ALTER TABLE "public"."ai_knowledge_ingest_batches" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_knowledge_ingest_batches" IS 'Server-only. Managed exclusively by the AI knowledge ingest pipeline (service_role). RLS enabled with no client policies is intentional — blocks direct client access.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_knowledge_ingest_candidates" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_knowledge_ingest_candidates_confidence_range" CHECK ((("confidence_score" IS NULL) OR (("confidence_score" >= (0)::numeric) AND ("confidence_score" <= (1)::numeric)))),
    CONSTRAINT "ai_knowledge_ingest_candidates_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['system'::"text", 'user'::"text", 'ai'::"text"]))),
    CONSTRAINT "ai_knowledge_ingest_candidates_evidence_array" CHECK (("jsonb_typeof"("source_evidence") = 'array'::"text")),
    CONSTRAINT "ai_knowledge_ingest_candidates_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_ingest_candidates_payload_object" CHECK (("jsonb_typeof"("proposed_payload") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_ingest_candidates_status_check" CHECK (("validation_status" = ANY (ARRAY['pending_review'::"text", 'approved'::"text", 'rejected'::"text", 'incorrect'::"text", 'promoted'::"text", 'failed'::"text"]))),
    CONSTRAINT "ai_knowledge_ingest_candidates_type_check" CHECK (("candidate_type" = ANY (ARRAY['node'::"text", 'edge'::"text", 'failed_source'::"text"])))
);


ALTER TABLE "public"."ai_knowledge_ingest_candidates" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_knowledge_ingest_candidates" IS 'Server-only. Managed exclusively by the AI knowledge ingest pipeline (service_role). RLS enabled with no client policies is intentional — blocks direct client access.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_knowledge_map_views" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_knowledge_map_views_filters_object" CHECK (("jsonb_typeof"("filters") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_map_views_layout_object" CHECK (("jsonb_typeof"("layout_settings") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_map_views_name_nonempty" CHECK (("length"(TRIM(BOTH FROM "name")) > 0))
);


ALTER TABLE "public"."ai_knowledge_map_views" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_knowledge_map_views" IS 'Server-only. Written by the AI knowledge map pipeline (service_role). RLS enabled with no client policies is intentional — blocks direct client access.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_knowledge_nodes" (
    ...
    "y" numeric,
    "z" numeric,
    "vector_coordinates" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "project" "text",
    CONSTRAINT "ai_knowledge_nodes_confidence_range" CHECK ((("confidence_score" IS NULL) OR (("confidence_score" >= (0)::numeric) AND ("confidence_score" <= (1)::numeric)))),
    CONSTRAINT "ai_knowledge_nodes_created_by_type_check" CHECK (("created_by_type" = ANY (ARRAY['system'::"text", 'user'::"text", 'ai'::"text"]))),
    CONSTRAINT "ai_knowledge_nodes_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_knowledge_nodes_risk_score_range" CHECK ((("risk_score" IS NULL) OR (("risk_score" >= (0)::numeric) AND ("risk_score" <= (100)::numeric)))),
    CONSTRAINT "ai_knowledge_nodes_source_nonempty" CHECK ((("length"(TRIM(BOTH FROM "source_table")) > 0) AND ("length"(TRIM(BOTH FROM "source_id")) > 0))),
    CONSTRAINT "ai_knowledge_nodes_title_nonempty" CHECK (("length"(TRIM(BOTH FROM "title")) > 0)),
    CONSTRAINT "ai_knowledge_nodes_validation_status_check" CHECK (("validation_status" = ANY (ARRAY['unreviewed'::"text", 'pending_review'::"text", 'approved'::"text", 'rejected'::"text", 'incorrect'::"text", 'needs_review'::"text"]))),
    CONSTRAINT "ai_knowledge_nodes_vector_coordinates_object" CHECK (("jsonb_typeof"("vector_coordinates") = 'object'::"text"))
);


ALTER TABLE "public"."ai_knowledge_nodes" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_knowledge_nodes" IS 'Server-only. Written via service_role AI knowledge ingest pipeline. RLS enabled with no client policies is intentional — blocks direct client access. Read access is exposed only through server-side safety intelligence API routes.';
...
CREATE TABLE IF NOT EXISTS "public"."ai_vector_memory" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "ai_vector_memory_content_nonempty" CHECK (("length"(TRIM(BOTH FROM "content_text")) > 0)),
    CONSTRAINT "ai_vector_memory_metadata_object" CHECK (("jsonb_typeof"("metadata") = 'object'::"text")),
    CONSTRAINT "ai_vector_memory_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'indexed'::"text", 'failed'::"text", 'fallback'::"text"])))
);


ALTER TABLE "public"."ai_vector_memory" OWNER TO "postgres";


COMMENT ON TABLE "public"."ai_vector_memory" IS 'Server-only. Vector embeddings store for company AI memory, managed via service_role. RLS enabled with no client policies is intentional — blocks direct client access. Similarity search is exposed only via server-side API routes, never direct table queries.';
...
CREATE TABLE IF NOT EXISTS "public"."approved_knowledge" (
    ...
    "review_status" "public"."gus_knowledge_review_status" DEFAULT 'current'::"public"."gus_knowledge_review_status" NOT NULL,
    ...
    CONSTRAINT "approved_knowledge_quality_score_check" CHECK ((("quality_score" >= (0)::numeric) AND ("quality_score" <= (100)::numeric))),
    CONSTRAINT "approved_knowledge_source_url_not_blank" CHECK (("length"(TRIM(BOTH FROM "source_url")) > 0)),
    CONSTRAINT "approved_knowledge_summary_not_blank" CHECK (("length"(TRIM(BOTH FROM "approved_summary")) > 0)),
    CONSTRAINT "approved_knowledge_title_not_blank" CHECK (("length"(TRIM(BOTH FROM "knowledge_title")) > 0)),
    CONSTRAINT "approved_knowledge_topic_not_blank" CHECK (("length"(TRIM(BOTH FROM "topic")) > 0)),
    CONSTRAINT "approved_knowledge_version_check" CHECK (("version" >= 1))
);


ALTER TABLE "public"."approved_knowledge" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."approved_sources" (
    ...
    "source_type" "public"."gus_learning_source_type" NOT NULL,
    "jurisdiction" "text" DEFAULT 'Federal'::"text" NOT NULL,
    "trust_level" "public"."gus_learning_trust_level" DEFAULT 'medium'::"public"."gus_learning_trust_level" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "approved_sources_domain_not_blank" CHECK (("length"(TRIM(BOTH FROM "domain")) > 0)),
    CONSTRAINT "approved_sources_name_not_blank" CHECK (("length"(TRIM(BOTH FROM "source_name")) > 0)),
    CONSTRAINT "approved_sources_url_not_blank" CHECK (("length"(TRIM(BOTH FROM "source_url")) > 0))
);


ALTER TABLE "public"."approved_sources" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."change_log" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "change_log_change_type_not_blank" CHECK (("length"(TRIM(BOTH FROM "change_type")) > 0)),
    CONSTRAINT "change_log_jobsite_requires_company" CHECK ((("jobsite_id" IS NULL) OR ("company_id" IS NOT NULL))),
    CONSTRAINT "change_log_object_id_not_blank" CHECK (("length"(TRIM(BOTH FROM "object_id")) > 0)),
    CONSTRAINT "change_log_object_type_not_blank" CHECK (("length"(TRIM(BOTH FROM "object_type")) > 0)),
    CONSTRAINT "change_log_risk_level_check" CHECK (("risk_level" = ANY (ARRAY['low'::"text", 'medium'::"text", 'high'::"text", 'critical'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."company_jobsite_emergency_defaults" (
    ...
    "responder_access_instructions" "text",
    "responder_site_address" "text",
    "assembly_area" "text",
    "secondary_assembly_area" "text",
    "command_post_location" "text",
    "evacuation_shelter_notes" "text",
    "weather_shelter_location" "text",
    "lightning_plan" "text",
    "tornado_plan" "text",
    "aed_location" "text",
    "first_aid_location" "text",
    "fire_extinguisher_locations" "text",
    "spill_kit_locations" "text",
    "rescue_equipment_locations" "text",
    "nearest_medical_name" "text",
    "nearest_medical_address" "text",
    "nearest_medical_phone" "text",
    "nearest_medical_route" "text",
    "media_contact_name" "text",
    "media_contact_phone" "text",
    "media_statement_instructions" "text",
    "regulatory_contact_name" "text",
    "regulatory_contact_phone" "text",
    "regulatory_reporting_instructions" "text",
    "call_chain" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "utility_contacts" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "after_hours_contacts" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "backup_contacts" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "incident_notification_timeline" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "post_incident_requirements" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "notes" "text",
    "revision_date" "date",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    ...
    "updated_by" "uuid",
    "archived_at" timestamp with time zone,
    CONSTRAINT "company_jobsite_emergency_defaults_medical_phone_length_check" CHECK ((("nearest_medical_phone" IS NULL) OR ("length"(TRIM(BOTH FROM "nearest_medical_phone")) <= 40))),
    CONSTRAINT "company_jobsite_emergency_defaults_phone_length_check" CHECK ((("emergency_contact_phone" IS NULL) OR ("length"(TRIM(BOTH FROM "emergency_contact_phone")) <= 40)))
);


ALTER TABLE "public"."company_jobsite_emergency_defaults" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."company_jobsite_emergency_profiles" (
    ...
    "post_incident_requirements" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "revision_date" "date",
    CONSTRAINT "company_jobsite_emergency_profiles_medical_phone_length_check" CHECK ((("nearest_medical_phone" IS NULL) OR ("length"(TRIM(BOTH FROM "nearest_medical_phone")) <= 40))),
    CONSTRAINT "company_jobsite_emergency_profiles_phone_length_check" CHECK ((("emergency_contact_phone" IS NULL) OR ("length"(TRIM(BOTH FROM "emergency_contact_phone")) <= 40)))
);


ALTER TABLE "public"."company_jobsite_emergency_profiles" OWNER TO "postgres";
...
COMMENT ON CONSTRAINT "company_risk_recommendation_events_event_type_check" ON "public"."company_risk_recommendation_events" IS 'Includes closed-loop outcome and learning events for AI recommendations linked to corrective actions.';
...
CREATE TABLE IF NOT EXISTS "public"."company_training_requirements" (
    ...
    "training_delivery_type" "text",
    "training_resource_title" "text",
    "training_resource_url" "text",
    "training_resource_instructions" "text",
    ...
    CONSTRAINT "company_training_requirements_training_delivery_type_check" CHECK ((("training_delivery_type" IS NULL) OR ("training_delivery_type" = ANY (ARRAY['online'::"text", 'internal'::"text"]))))
);
...
COMMENT ON COLUMN "public"."company_training_requirements"."training_delivery_type" IS 'How an assigned worker should access this training: online external course or internal company/app page.';



COMMENT ON COLUMN "public"."company_training_requirements"."training_resource_title" IS 'Worker-facing label for the training resource sent with assignments.';



COMMENT ON COLUMN "public"."company_training_requirements"."training_resource_url" IS 'Validated assignment URL. Use https:// links or same-origin app paths such as /training/module.';



COMMENT ON COLUMN "public"."company_training_requirements"."training_resource_instructions" IS 'Optional worker-facing instructions included with assignment notifications.';
...
CREATE TABLE IF NOT EXISTS "public"."event_log" (
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "event_log_action_not_blank" CHECK (("length"(TRIM(BOTH FROM "action")) > 0)),
    CONSTRAINT "event_log_jobsite_requires_company" CHECK ((("jobsite_id" IS NULL) OR ("company_id" IS NOT NULL))),
    CONSTRAINT "event_log_module_not_blank" CHECK (("length"(TRIM(BOTH FROM "module")) > 0)),
    CONSTRAINT "event_log_object_type_not_blank" CHECK (("length"(TRIM(BOTH FROM "object_type")) > 0)),
    CONSTRAINT "event_log_severity_check" CHECK (("severity" = ANY (ARRAY['low'::"text", 'medium'::"text", 'high'::"text", 'critical'::"text"]))),
    CONSTRAINT "event_log_status_check" CHECK (("event_status" = ANY (ARRAY['recorded'::"text", 'pending_review'::"text", 'resolved'::"text", 'failed'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."gus_answer_audit" (
    ...
    "retrieval_method" "text" DEFAULT 'none'::"text" NOT NULL,
    "selected_knowledge_ids" "uuid"[] DEFAULT '{}'::"uuid"[] NOT NULL,
    "rejected_candidate_ids" "uuid"[] DEFAULT '{}'::"uuid"[] NOT NULL,
    ...
    "citation_snippets" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "quality_signals" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "gus_answer_audit_answer_hash_not_blank" CHECK (("length"(TRIM(BOTH FROM "answer_text_hash")) > 0)),
    CONSTRAINT "gus_answer_audit_answer_id_not_blank" CHECK (("length"(TRIM(BOTH FROM "answer_id")) > 0)),
    CONSTRAINT "gus_answer_audit_confidence_check" CHECK (("confidence" = ANY (ARRAY['High'::"text", 'Medium'::"text", 'Low'::"text"]))),
    CONSTRAINT "gus_answer_audit_question_hash_not_blank" CHECK (("length"(TRIM(BOTH FROM "question_hash")) > 0)),
    CONSTRAINT "gus_answer_audit_question_not_blank" CHECK (("length"(TRIM(BOTH FROM "question")) > 0))
);


ALTER TABLE "public"."gus_answer_audit" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gus_answer_feedback" (
    ...
    "review_status" "public"."gus_research_status" DEFAULT 'pending_review'::"public"."gus_research_status" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "answer_audit_id" "uuid",
    CONSTRAINT "gus_answer_feedback_answer_id_not_blank" CHECK (("length"(TRIM(BOTH FROM "answer_id")) > 0))
);


ALTER TABLE "public"."gus_answer_feedback" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."gus_learning_review_items" (
    ...
    "status" "public"."gus_learning_review_item_status" DEFAULT 'pending_review'::"public"."gus_learning_review_item_status" NOT NULL,
    "title" "text" NOT NULL,
    "user_comment" "text",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "gus_learning_review_items_action_not_blank" CHECK (("length"(TRIM(BOTH FROM "recommended_admin_action")) > 0)),
    CONSTRAINT "gus_learning_review_items_title_not_blank" CHECK (("length"(TRIM(BOTH FROM "title")) > 0))
);


ALTER TABLE "public"."gus_learning_review_items" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."health_score_snapshots" (
    ...
    "ai_engine_score" numeric(5,2),
    "prediction_value_score" numeric(5,2),
    "data_quality_score" numeric(5,2),
    "cyber_health_score" numeric(5,2),
    "owner_validation_score" numeric(5,2),
    "help_ticket_score" numeric(5,2),
    "explanation" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "health_score_snapshots_category_score_check" CHECK (((("system_health_score" IS NULL) OR (("system_health_score" >= (0)::numeric) AND ("system_health_score" <= (100)::numeric))) AND (("ai_engine_score" IS NULL) OR (("ai_engine_score" >= (0)::numeric) AND ("ai_engine_score" <= (100)::numeric))) AND (("prediction_value_score" IS NULL) OR (("prediction_value_score" >= (0)::numeric) AND ("prediction_value_score" <= (100)::numeric))) AND (("data_quality_score" IS NULL) OR (("data_quality_score" >= (0)::numeric) AND ("data_quality_score" <= (100)::numeric))) AND (("cyber_health_score" IS NULL) OR (("cyber_health_score" >= (0)::numeric) AND ("cyber_health_score" <= (100)::numeric))) AND (("owner_validation_score" IS NULL) OR (("owner_validation_score" >= (0)::numeric) AND ("owner_validation_score" <= (100)::numeric))) AND (("help_ticket_score" IS NULL) OR (("help_ticket_score" >= (0)::numeric) AND ("help_ticket_score" <= (100)::numeric))))),
    CONSTRAINT "health_score_snapshots_jobsite_requires_company" CHECK ((("jobsite_id" IS NULL) OR ("company_id" IS NOT NULL))),
    CONSTRAINT "health_score_snapshots_overall_score_check" CHECK ((("overall_score" >= (0)::numeric) AND ("overall_score" <= (100)::numeric)))
);


ALTER TABLE "public"."health_score_snapshots" OWNER TO "postgres";
...
ALTER TABLE "public"."knowledge_change_log" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_change_log_entries" (
    ...
    "pages_affected" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "risk_level" "text" DEFAULT 'Medium'::"text" NOT NULL,
    "owner_review_required" boolean DEFAULT true NOT NULL,
    "validation_checklist_url" "text",
    "related_page_url" "text",
    "customer_ready_status" "text" DEFAULT 'Needs owner review'::"text" NOT NULL,
    "why_changed" "text" DEFAULT ''::"text" NOT NULL,
    "what_could_break" "text" DEFAULT ''::"text" NOT NULL,
    "owner_manual_review" "text" DEFAULT ''::"text" NOT NULL,
    "safe_to_show_customer" "text" DEFAULT 'Needs Review'::"text" NOT NULL,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "owner_change_log_entries_customer_ready_status_check" CHECK (("customer_ready_status" = ANY (ARRAY['Not tested'::"text", 'Blocked'::"text", 'Needs owner review'::"text", 'Approved for demo'::"text", 'Approved for customer use'::"text"]))),
    CONSTRAINT "owner_change_log_entries_risk_level_check" CHECK (("risk_level" = ANY (ARRAY['Low'::"text", 'Medium'::"text", 'High'::"text"]))),
    CONSTRAINT "owner_change_log_entries_safe_to_show_check" CHECK (("safe_to_show_customer" = ANY (ARRAY['Yes'::"text", 'No'::"text", 'Needs Review'::"text"])))
);


ALTER TABLE "public"."owner_change_log_entries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."owner_customer_ready_gates" (
    "module_key" "text" NOT NULL,
    "automated_validation_status" "text" DEFAULT 'gray'::"text" NOT NULL,
    "owner_visual_review_status" "text" DEFAULT 'not_started'::"text" NOT NULL,
    "customer_ready" boolean DEFAULT false NOT NULL,
    "blocking_reason" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "customer_ready_status" "text" DEFAULT 'Not tested'::"text" NOT NULL,
    "super_admin_approved" boolean DEFAULT false NOT NULL,
    "approved_by" "uuid",
    "approved_at" timestamp with time zone,
    "latest_owner_proof_report_id" "uuid",
    CONSTRAINT "owner_customer_ready_gates_auto_status_check" CHECK (("automated_validation_status" = ANY (ARRAY['green'::"text", 'yellow'::"text", 'red'::"text", 'gray'::"text"]))),
    CONSTRAINT "owner_customer_ready_gates_customer_ready_status_check" CHECK (("customer_ready_status" = ANY (ARRAY['Not tested'::"text", 'Blocked'::"text", 'Needs owner review'::"text", 'Approved for demo'::"text", 'Approved for customer use'::"text"]))),
    CONSTRAINT "owner_customer_ready_gates_ready_check" CHECK ((("customer_ready" = false) OR (("customer_ready_status" = 'Approved for customer use'::"text") AND ("automated_validation_status" = ANY (ARRAY['green'::"text", 'yellow'::"text"])) AND ("owner_visual_review_status" = 'passed'::"text") AND ("super_admin_approved" = true) AND ("approved_by" IS NOT NULL) AND ("approved_at" IS NOT NULL) AND ("latest_owner_proof_report_id" IS NOT NULL) AND ("blocking_reason" IS NULL)))),
    CONSTRAINT "owner_customer_ready_gates_review_status_check" CHECK (("owner_visual_review_status" = ANY (ARRAY['not_started'::"text", 'passed'::"text", 'needs_review'::"text", 'failed'::"text"])))
);


ALTER TABLE "public"."owner_customer_ready_gates" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_gus_validation_results" (
    ...
    "company_context_used" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "source_rules_used" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "warnings" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "validation_findings" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "blocked_by_rules" boolean DEFAULT false NOT NULL,
    "fallback_used" boolean DEFAULT false NOT NULL,
    "approved_by" "uuid",
    "approved_at" timestamp with time zone,
    "flagged_by" "uuid",
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "owner_gus_validation_results_status_check" CHECK (("validation_status" = ANY (ARRAY['needs_review'::"text", 'approved'::"text", 'flagged'::"text"])))
);


ALTER TABLE "public"."owner_gus_validation_results" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_gus_validation_test_cases" (
    ...
    "title" "text" NOT NULL,
    "scenario" "text" NOT NULL,
    "expected_focus" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "created_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL
);
...
ALTER TABLE "public"."owner_gus_validation_test_cases" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_manual_review_items" (
    ...
    "required" boolean DEFAULT true NOT NULL,
    CONSTRAINT "owner_manual_review_items_status_check" CHECK (("status" = ANY (ARRAY['not_started'::"text", 'passed'::"text", 'needs_review'::"text", 'failed'::"text"])))
);


ALTER TABLE "public"."owner_manual_review_items" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_registry" (
    ...
    "object_type" "text",
    "object_id" "text",
    "validation_status" "text" DEFAULT 'pending_verification'::"text" NOT NULL,
    ...
    CONSTRAINT "owner_registry_authority_level_check" CHECK (("authority_level" = ANY (ARRAY['standard'::"text", 'elevated'::"text", 'critical'::"text", 'second_approval'::"text"]))),
    CONSTRAINT "owner_registry_jobsite_requires_company" CHECK ((("jobsite_id" IS NULL) OR ("company_id" IS NOT NULL))),
    CONSTRAINT "owner_registry_owner_type_not_blank" CHECK (("length"(TRIM(BOTH FROM "owner_type")) > 0)),
    CONSTRAINT "owner_registry_validation_status_check" CHECK (("validation_status" = ANY (ARRAY['verified'::"text", 'pending_verification'::"text", 'conflicting_owner'::"text", 'unauthorized_owner'::"text", 'expired_authority'::"text", 'requires_second_approval'::"text"])))
);


ALTER TABLE "public"."owner_registry" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_validation_check_results" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "owner_validation_check_results_status_check" CHECK (("status" = ANY (ARRAY['green'::"text", 'yellow'::"text", 'red'::"text", 'gray'::"text"])))
);


ALTER TABLE "public"."owner_validation_check_results" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."owner_validation_modules" (
    "module_key" "text" NOT NULL,
    "display_name" "text" NOT NULL,
    "status" "text" DEFAULT 'gray'::"text" NOT NULL,
    "summary" "text" DEFAULT 'Not tested yet.'::"text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "owner_validation_modules_status_check" CHECK (("status" = ANY (ARRAY['green'::"text", 'yellow'::"text", 'red'::"text", 'gray'::"text"])))
);


ALTER TABLE "public"."owner_validation_modules" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."owner_validation_runs" (
    ...
    "completed_at" timestamp with time zone,
    "started_by" "uuid",
    "overall_status" "text" DEFAULT 'gray'::"text" NOT NULL,
    "overall_score" integer DEFAULT 0 NOT NULL,
    "passed_count" integer DEFAULT 0 NOT NULL,
    "warning_count" integer DEFAULT 0 NOT NULL,
    "failed_count" integer DEFAULT 0 NOT NULL,
    "summary" "text" DEFAULT 'Validation run started.'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "owner_validation_runs_counts_check" CHECK ((("passed_count" >= 0) AND ("warning_count" >= 0) AND ("failed_count" >= 0))),
    CONSTRAINT "owner_validation_runs_score_check" CHECK ((("overall_score" >= 0) AND ("overall_score" <= 100))),
    CONSTRAINT "owner_validation_runs_status_check" CHECK (("overall_status" = ANY (ARRAY['green'::"text", 'yellow'::"text", 'red'::"text", 'gray'::"text"])))
);


ALTER TABLE "public"."owner_validation_runs" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."owner_validation_sandbox_records" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "sandbox_key" "text" NOT NULL,
    "sandbox_company_id" "uuid",
...
ALTER TABLE "public"."owner_validation_sandbox_records" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."platform_help_tickets" (
    ...
    "assigned_superadmin_user_id" "uuid",
    "superadmin_seen_at" timestamp with time zone,
    "superadmin_seen_by" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "resolved_at" timestamp with time zone,
    "closed_at" timestamp with time zone,
    ...
    CONSTRAINT "platform_help_tickets_category_check" CHECK (("category" = ANY (ARRAY['login_access'::"text", 'documents'::"text", 'jobsites'::"text", 'billing'::"text", 'integrations'::"text", 'performance'::"text", 'bug'::"text", 'other'::"text"]))),
    CONSTRAINT "platform_help_tickets_description_nonempty" CHECK (("length"(TRIM(BOTH FROM "description")) > 0)),
    CONSTRAINT "platform_help_tickets_jobsite_requires_company" CHECK ((("jobsite_id" IS NULL) OR ("company_id" IS NOT NULL))),
    CONSTRAINT "platform_help_tickets_priority_check" CHECK (("priority" = ANY (ARRAY['normal'::"text", 'high'::"text", 'critical'::"text"]))),
    CONSTRAINT "platform_help_tickets_severity_check" CHECK ((("severity" IS NULL) OR ("severity" = ANY (ARRAY['low'::"text", 'medium'::"text", 'high'::"text", 'critical'::"text"])))),
    CONSTRAINT "platform_help_tickets_status_check" CHECK (("status" = ANY (ARRAY['open'::"text", 'in_progress'::"text", 'waiting_on_user'::"text", 'resolved'::"text", 'closed'::"text"]))),
    CONSTRAINT "platform_help_tickets_title_nonempty" CHECK (("length"(TRIM(BOTH FROM "title")) > 0))
);


ALTER TABLE "public"."platform_help_tickets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."research_queue" (
    ...
    "raw_summary" "text" DEFAULT ''::"text" NOT NULL,
    "ai_confidence" numeric(4,3),
    "jurisdiction" "text" DEFAULT 'Federal'::"text" NOT NULL,
    "affected_modules" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "status" "public"."gus_research_status" DEFAULT 'pending_review'::"public"."gus_research_status" NOT NULL,
    "reviewer_id" "uuid",
    "reviewer_notes" "text",
    "reviewed_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "research_queue_ai_confidence_check" CHECK ((("ai_confidence" IS NULL) OR (("ai_confidence" >= (0)::numeric) AND ("ai_confidence" <= (1)::numeric)))),
    CONSTRAINT "research_queue_question_not_blank" CHECK (("length"(TRIM(BOTH FROM "question")) > 0)),
    CONSTRAINT "research_queue_source_url_not_blank" CHECK (("length"(TRIM(BOTH FROM "source_url")) > 0)),
    CONSTRAINT "research_queue_topic_not_blank" CHECK (("length"(TRIM(BOTH FROM "topic")) > 0))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_profiles" (
    ...
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "certification_expirations" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "gus_notification_settings" "jsonb" DEFAULT '{"emailEnabled": true, "inAppEnabled": true, "textOnlyMode": false, "voiceEnabled": false, "autoOpenEnabled": true}'::"jsonb" NOT NULL,
...
COMMENT ON COLUMN "public"."user_profiles"."gus_notification_settings" IS 'Per-user Gus notification and voice preferences. Critical safety escalations may still surface in-app for human review.';
...
ALTER TABLE ONLY "public"."ai_engine_events"
    ADD CONSTRAINT "ai_engine_events_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_improvement_audit_events"
    ADD CONSTRAINT "ai_improvement_audit_events_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_improvement_requests"
    ADD CONSTRAINT "ai_improvement_requests_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_unique" UNIQUE ("company_id", "source_node_id", "target_node_id", "relationship_type");



ALTER TABLE ONLY "public"."ai_knowledge_ingest_batches"
    ADD CONSTRAINT "ai_knowledge_ingest_batches_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_map_views"
    ADD CONSTRAINT "ai_knowledge_map_views_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_nodes"
    ADD CONSTRAINT "ai_knowledge_nodes_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_knowledge_nodes"
    ADD CONSTRAINT "ai_knowledge_nodes_source_unique" UNIQUE ("company_id", "source_table", "source_id");
...
ALTER TABLE ONLY "public"."ai_vector_memory"
    ADD CONSTRAINT "ai_vector_memory_node_unique" UNIQUE ("node_id");



ALTER TABLE ONLY "public"."ai_vector_memory"
    ADD CONSTRAINT "ai_vector_memory_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."approved_sources"
    ADD CONSTRAINT "approved_sources_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."company_jobsite_emergency_defaults"
    ADD CONSTRAINT "company_jobsite_emergency_defaults_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."company_jobsite_emergency_defaults"
    ADD CONSTRAINT "company_jobsite_emergency_defaults_unique_company" UNIQUE ("company_id");



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_unique_jobsite" UNIQUE ("company_id", "jobsite_id");
...
ALTER TABLE ONLY "public"."gus_answer_audit"
    ADD CONSTRAINT "gus_answer_audit_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gus_answer_feedback"
    ADD CONSTRAINT "gus_answer_feedback_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."health_score_snapshots"
    ADD CONSTRAINT "health_score_snapshots_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."knowledge_change_log"
    ADD CONSTRAINT "knowledge_change_log_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."owner_change_log_entries"
    ADD CONSTRAINT "owner_change_log_entries_change_key_key" UNIQUE ("change_key");



ALTER TABLE ONLY "public"."owner_change_log_entries"
    ADD CONSTRAINT "owner_change_log_entries_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_customer_ready_gates"
    ADD CONSTRAINT "owner_customer_ready_gates_pkey" PRIMARY KEY ("module_key");



ALTER TABLE ONLY "public"."owner_gus_validation_results"
    ADD CONSTRAINT "owner_gus_validation_results_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_gus_validation_test_cases"
    ADD CONSTRAINT "owner_gus_validation_test_cases_case_key_key" UNIQUE ("case_key");



ALTER TABLE ONLY "public"."owner_gus_validation_test_cases"
    ADD CONSTRAINT "owner_gus_validation_test_cases_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_manual_review_items"
    ADD CONSTRAINT "owner_manual_review_items_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_registry"
    ADD CONSTRAINT "owner_registry_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_validation_check_results"
    ADD CONSTRAINT "owner_validation_check_results_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_validation_modules"
    ADD CONSTRAINT "owner_validation_modules_pkey" PRIMARY KEY ("module_key");



ALTER TABLE ONLY "public"."owner_validation_runs"
    ADD CONSTRAINT "owner_validation_runs_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_validation_sandbox_records"
    ADD CONSTRAINT "owner_validation_sandbox_records_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."owner_validation_sandbox_records"
    ADD CONSTRAINT "owner_validation_sandbox_records_unique" UNIQUE ("sandbox_key", "record_table", "record_id");
...
ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "ai_engine_events_created_idx" ON "public"."ai_engine_events" USING "btree" ("company_id", "created_at" DESC);
...
CREATE INDEX "ai_engine_validation_logs_created_idx" ON "public"."ai_engine_validation_logs" USING "btree" ("company_id", "created_at" DESC);



CREATE INDEX "ai_improvement_audit_events_event_created_idx" ON "public"."ai_improvement_audit_events" USING "btree" ("event_type", "created_at" DESC);



CREATE INDEX "ai_improvement_audit_events_request_created_idx" ON "public"."ai_improvement_audit_events" USING "btree" ("improvement_request_id", "created_at" DESC);



CREATE INDEX "ai_improvement_requests_branch_idx" ON "public"."ai_improvement_requests" USING "btree" ("branch_name") WHERE ("branch_name" IS NOT NULL);



CREATE INDEX "ai_improvement_requests_risk_created_idx" ON "public"."ai_improvement_requests" USING "btree" ("risk_level", "created_at" DESC);



CREATE INDEX "ai_improvement_requests_status_created_idx" ON "public"."ai_improvement_requests" USING "btree" ("status", "created_at" DESC);



CREATE INDEX "ai_knowledge_edges_company_status_idx" ON "public"."ai_knowledge_edges" USING "btree" ("company_id", "validation_status", "relationship_type", "updated_at" DESC);



CREATE INDEX "ai_knowledge_edges_source_idx" ON "public"."ai_knowledge_edges" USING "btree" ("company_id", "source_node_id");



CREATE INDEX "ai_knowledge_edges_target_idx" ON "public"."ai_knowledge_edges" USING "btree" ("company_id", "target_node_id");



CREATE INDEX "ai_knowledge_ingest_batches_company_status_idx" ON "public"."ai_knowledge_ingest_batches" USING "btree" ("company_id", "status", "created_at" DESC);



CREATE INDEX "ai_knowledge_ingest_candidates_batch_idx" ON "public"."ai_knowledge_ingest_candidates" USING "btree" ("batch_id", "validation_status", "candidate_type");



CREATE INDEX "ai_knowledge_ingest_candidates_company_status_idx" ON "public"."ai_knowledge_ingest_candidates" USING "btree" ("company_id", "validation_status", "candidate_type", "created_at" DESC);



CREATE INDEX "ai_knowledge_ingest_candidates_source_idx" ON "public"."ai_knowledge_ingest_candidates" USING "btree" ("company_id", "source_table", "source_id");



CREATE INDEX "ai_knowledge_map_views_user_idx" ON "public"."ai_knowledge_map_views" USING "btree" ("user_id", "updated_at" DESC);



CREATE INDEX "ai_knowledge_nodes_company_type_idx" ON "public"."ai_knowledge_nodes" USING "btree" ("company_id", "node_type", "risk_level", "updated_at" DESC);



CREATE INDEX "ai_knowledge_nodes_source_idx" ON "public"."ai_knowledge_nodes" USING "btree" ("source_table", "source_id");



CREATE INDEX "ai_knowledge_nodes_vector_hnsw" ON "public"."ai_knowledge_nodes" USING "hnsw" ("embedding" "extensions"."vector_cosine_ops") WHERE ("embedding" IS NOT NULL);
...
CREATE INDEX "ai_vector_memory_embedding_hnsw" ON "public"."ai_vector_memory" USING "hnsw" ("embedding" "extensions"."vector_cosine_ops") WHERE ("embedding" IS NOT NULL);



CREATE INDEX "ai_vector_memory_source_idx" ON "public"."ai_vector_memory" USING "btree" ("company_id", "source_table", "source_id");



CREATE INDEX "ai_visual_generation_jobs_blueprint_id_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("blueprint_id") WHERE ("blueprint_id" IS NOT NULL);
...
CREATE INDEX "ai_visual_generation_jobs_created_by_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("created_by") WHERE ("created_by" IS NOT NULL);



CREATE INDEX "ai_visual_generation_jobs_jobsite_id_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("jobsite_id");
...
CREATE INDEX "ai_visual_generation_jobs_render_id_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("render_id") WHERE ("render_id" IS NOT NULL);



CREATE INDEX "ai_visual_generation_jobs_site_map_id_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("site_map_id") WHERE ("site_map_id" IS NOT NULL);
...
CREATE INDEX "ai_visual_generation_jobs_updated_by_idx" ON "public"."ai_visual_generation_jobs" USING "btree" ("updated_by") WHERE ("updated_by" IS NOT NULL);



CREATE INDEX "approved_knowledge_company_priority_idx" ON "public"."approved_knowledge" USING "btree" ("company_id", "project_id", "required_control_type", "review_status", "is_active", "approved_at" DESC);



CREATE INDEX "approved_knowledge_embedding_hnsw" ON "public"."approved_knowledge" USING "hnsw" ("embedding" "extensions"."vector_cosine_ops") WHERE (("embedding" IS NOT NULL) AND ("is_active" = true));



CREATE INDEX "approved_knowledge_quality_idx" ON "public"."approved_knowledge" USING "btree" ("company_id", "quality_score" DESC, "review_status", "is_active");



CREATE INDEX "approved_knowledge_review_due_idx" ON "public"."approved_knowledge" USING "btree" ("review_due_date", "review_status", "is_active");



CREATE INDEX "approved_knowledge_supersession_idx" ON "public"."approved_knowledge" USING "btree" ("supersedes_knowledge_id", "superseded_by_knowledge_id");



CREATE INDEX "approved_sources_scope_idx" ON "public"."approved_sources" USING "btree" ("company_id", "domain", "is_active", "trust_level");
...
CREATE INDEX "change_log_company_created_idx" ON "public"."change_log" USING "btree" ("company_id", "created_at" DESC) WHERE ("company_id" IS NOT NULL);



CREATE INDEX "change_log_jobsite_created_idx" ON "public"."change_log" USING "btree" ("jobsite_id", "created_at" DESC) WHERE ("jobsite_id" IS NOT NULL);



CREATE INDEX "change_log_object_idx" ON "public"."change_log" USING "btree" ("object_type", "object_id", "created_at" DESC);



CREATE INDEX "change_log_owner_idx" ON "public"."change_log" USING "btree" ("owner_id", "created_at" DESC) WHERE ("owner_id" IS NOT NULL);



CREATE INDEX "change_log_risk_created_idx" ON "public"."change_log" USING "btree" ("risk_level", "created_at" DESC);



CREATE INDEX "change_log_tenant_created_idx" ON "public"."change_log" USING "btree" ("tenant_id", "created_at" DESC);
...
CREATE INDEX "company_jobsite_emergency_defaults_company_idx" ON "public"."company_jobsite_emergency_defaults" USING "btree" ("company_id") WHERE ("archived_at" IS NULL);



CREATE INDEX "company_jobsite_emergency_profiles_company_jobsite_idx" ON "public"."company_jobsite_emergency_profiles" USING "btree" ("company_id", "jobsite_id") WHERE ("archived_at" IS NULL);
...
CREATE INDEX "company_memory_items_embedding_hnsw" ON "public"."company_memory_items" USING "hnsw" ("embedding" "extensions"."vector_cosine_ops") WHERE ("embedding" IS NOT NULL);
...
CREATE INDEX "contractor_employee_intake_tokens_company_jobsite_idx" ON "public"."contractor_employee_intake_tokens" USING "btree" ("company_id", "jobsite_id", "created_at" DESC);



CREATE INDEX "contractor_employee_intake_tokens_contractor_employee_idx" ON "public"."contractor_employee_intake_tokens" USING "btree" ("contractor_employee_id", "created_at" DESC);



CREATE INDEX "contractor_employee_jobsite_assignments_contractor_idx" ON "public"."contractor_employee_jobsite_assignments" USING "btree" ("contractor_id") WHERE ("contractor_id" IS NOT NULL);



CREATE INDEX "contractor_employee_jobsite_assignments_employee_idx" ON "public"."contractor_employee_jobsite_assignments" USING "btree" ("contractor_employee_id");
...
CREATE INDEX "contractor_employee_profiles_created_by_idx" ON "public"."contractor_employee_profiles" USING "btree" ("created_by") WHERE ("created_by" IS NOT NULL);
...
CREATE INDEX "contractor_employee_training_records_requirement_idx" ON "public"."contractor_employee_training_records" USING "btree" ("requirement_id") WHERE ("requirement_id" IS NOT NULL);
...
CREATE INDEX "event_log_company_created_idx" ON "public"."event_log" USING "btree" ("company_id", "created_at" DESC) WHERE ("company_id" IS NOT NULL);



CREATE INDEX "event_log_jobsite_created_idx" ON "public"."event_log" USING "btree" ("jobsite_id", "created_at" DESC) WHERE ("jobsite_id" IS NOT NULL);



CREATE INDEX "event_log_object_idx" ON "public"."event_log" USING "btree" ("object_type", "object_id", "created_at" DESC);



CREATE INDEX "event_log_owner_idx" ON "public"."event_log" USING "btree" ("owner_id", "created_at" DESC) WHERE ("owner_id" IS NOT NULL);



CREATE INDEX "event_log_severity_status_idx" ON "public"."event_log" USING "btree" ("severity", "event_status", "created_at" DESC);



CREATE INDEX "event_log_tenant_created_idx" ON "public"."event_log" USING "btree" ("tenant_id", "created_at" DESC);



CREATE INDEX "gus_answer_audit_answer_id_idx" ON "public"."gus_answer_audit" USING "btree" ("answer_id");



CREATE INDEX "gus_answer_audit_company_created_idx" ON "public"."gus_answer_audit" USING "btree" ("company_id", "created_at" DESC);



CREATE INDEX "gus_answer_feedback_audit_idx" ON "public"."gus_answer_feedback" USING "btree" ("answer_audit_id");



CREATE INDEX "gus_answer_feedback_review_idx" ON "public"."gus_answer_feedback" USING "btree" ("company_id", "needs_admin_review", "created_at" DESC);
...
CREATE INDEX "gus_learning_review_items_company_status_idx" ON "public"."gus_learning_review_items" USING "btree" ("company_id", "status", "created_at" DESC);



CREATE INDEX "gus_learning_review_items_feedback_idx" ON "public"."gus_learning_review_items" USING "btree" ("feedback_id");
...
CREATE INDEX "health_score_snapshots_company_created_idx" ON "public"."health_score_snapshots" USING "btree" ("company_id", "created_at" DESC) WHERE ("company_id" IS NOT NULL);



CREATE INDEX "health_score_snapshots_jobsite_created_idx" ON "public"."health_score_snapshots" USING "btree" ("jobsite_id", "created_at" DESC) WHERE ("jobsite_id" IS NOT NULL);



CREATE INDEX "health_score_snapshots_tenant_created_idx" ON "public"."health_score_snapshots" USING "btree" ("tenant_id", "created_at" DESC);
...
CREATE INDEX "knowledge_change_log_company_created_idx" ON "public"."knowledge_change_log" USING "btree" ("company_id", "created_at" DESC);
...
CREATE INDEX "owner_change_log_entries_changed_at_idx" ON "public"."owner_change_log_entries" USING "btree" ("changed_at" DESC);



CREATE INDEX "owner_change_log_entries_module_key_idx" ON "public"."owner_change_log_entries" USING "btree" ("module_key");



CREATE INDEX "owner_customer_ready_gates_status_idx" ON "public"."owner_customer_ready_gates" USING "btree" ("customer_ready_status");



CREATE INDEX "owner_gus_validation_results_created_at_idx" ON "public"."owner_gus_validation_results" USING "btree" ("created_at" DESC);



CREATE INDEX "owner_gus_validation_results_test_case_id_idx" ON "public"."owner_gus_validation_results" USING "btree" ("test_case_id");



CREATE INDEX "owner_gus_validation_test_cases_case_key_idx" ON "public"."owner_gus_validation_test_cases" USING "btree" ("case_key");



CREATE UNIQUE INDEX "owner_manual_review_items_module_item_uidx" ON "public"."owner_manual_review_items" USING "btree" ("module_key", "checklist_item");



CREATE INDEX "owner_manual_review_items_module_key_idx" ON "public"."owner_manual_review_items" USING "btree" ("module_key");



CREATE INDEX "owner_registry_company_idx" ON "public"."owner_registry" USING "btree" ("company_id", "validation_status", "created_at" DESC) WHERE ("company_id" IS NOT NULL);



CREATE INDEX "owner_registry_jobsite_idx" ON "public"."owner_registry" USING "btree" ("jobsite_id", "validation_status", "created_at" DESC) WHERE ("jobsite_id" IS NOT NULL);



CREATE INDEX "owner_registry_object_idx" ON "public"."owner_registry" USING "btree" ("object_type", "object_id", "validation_status");



CREATE INDEX "owner_registry_owner_user_idx" ON "public"."owner_registry" USING "btree" ("owner_user_id", "validation_status", "created_at" DESC);



CREATE INDEX "owner_registry_tenant_idx" ON "public"."owner_registry" USING "btree" ("tenant_id", "validation_status", "created_at" DESC);



CREATE INDEX "owner_validation_check_results_module_key_idx" ON "public"."owner_validation_check_results" USING "btree" ("module_key");



CREATE INDEX "owner_validation_check_results_run_id_idx" ON "public"."owner_validation_check_results" USING "btree" ("run_id");



CREATE INDEX "owner_validation_modules_status_idx" ON "public"."owner_validation_modules" USING "btree" ("status");



CREATE INDEX "owner_validation_runs_started_at_idx" ON "public"."owner_validation_runs" USING "btree" ("started_at" DESC);



CREATE INDEX "owner_validation_sandbox_records_company_idx" ON "public"."owner_validation_sandbox_records" USING "btree" ("sandbox_company_id", "record_table");



CREATE INDEX "owner_validation_sandbox_records_key_idx" ON "public"."owner_validation_sandbox_records" USING "btree" ("sandbox_key", "record_kind");
...
CREATE INDEX "platform_help_tickets_company_idx" ON "public"."platform_help_tickets" USING "btree" ("company_id", "created_at" DESC) WHERE ("company_id" IS NOT NULL);



CREATE INDEX "platform_help_tickets_jobsite_created_idx" ON "public"."platform_help_tickets" USING "btree" ("jobsite_id", "created_at" DESC) WHERE ("jobsite_id" IS NOT NULL);



CREATE INDEX "platform_help_tickets_owner_idx" ON "public"."platform_help_tickets" USING "btree" ("owner_id", "created_at" DESC) WHERE ("owner_id" IS NOT NULL);



CREATE INDEX "platform_help_tickets_queue_idx" ON "public"."platform_help_tickets" USING "btree" ("status", "priority", "created_at" DESC);



CREATE INDEX "platform_help_tickets_severity_status_idx" ON "public"."platform_help_tickets" USING "btree" ("severity", "status", "created_at" DESC) WHERE ("severity" IS NOT NULL);



CREATE INDEX "platform_help_tickets_source_idx" ON "public"."platform_help_tickets" USING "btree" ("source_type", "source_id", "created_at" DESC) WHERE ("source_type" IS NOT NULL);



CREATE INDEX "platform_help_tickets_submitter_idx" ON "public"."platform_help_tickets" USING "btree" ("submitter_user_id", "created_at" DESC);



CREATE INDEX "platform_help_tickets_tenant_created_idx" ON "public"."platform_help_tickets" USING "btree" ("tenant_id", "created_at" DESC) WHERE ("tenant_id" IS NOT NULL);



CREATE INDEX "platform_help_tickets_unseen_idx" ON "public"."platform_help_tickets" USING "btree" ("created_at" DESC) WHERE (("superadmin_seen_at" IS NULL) AND ("status" = ANY (ARRAY['open'::"text", 'in_progress'::"text", 'waiting_on_user'::"text"])));
...
CREATE INDEX "research_queue_company_status_idx" ON "public"."research_queue" USING "btree" ("company_id", "status", "created_at" DESC);



CREATE INDEX "research_queue_project_status_idx" ON "public"."research_queue" USING "btree" ("company_id", "project_id", "status", "created_at" DESC);
...
CREATE OR REPLACE TRIGGER "set_ai_improvement_requests_updated_at" BEFORE UPDATE ON "public"."ai_improvement_requests" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_knowledge_edges_updated_at" BEFORE UPDATE ON "public"."ai_knowledge_edges" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_knowledge_ingest_batches_updated_at" BEFORE UPDATE ON "public"."ai_knowledge_ingest_batches" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_knowledge_ingest_candidates_updated_at" BEFORE UPDATE ON "public"."ai_knowledge_ingest_candidates" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_knowledge_map_views_updated_at" BEFORE UPDATE ON "public"."ai_knowledge_map_views" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_knowledge_nodes_updated_at" BEFORE UPDATE ON "public"."ai_knowledge_nodes" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_ai_vector_memory_updated_at" BEFORE UPDATE ON "public"."ai_vector_memory" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_approved_knowledge_updated_at" BEFORE UPDATE ON "public"."approved_knowledge" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_approved_sources_updated_at" BEFORE UPDATE ON "public"."approved_sources" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_company_jobsite_emergency_defaults_updated_at" BEFORE UPDATE ON "public"."company_jobsite_emergency_defaults" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_company_jobsite_emergency_profiles_updated_at" BEFORE UPDATE ON "public"."company_jobsite_emergency_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_gus_learning_review_items_updated_at" BEFORE UPDATE ON "public"."gus_learning_review_items" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_owner_change_log_entries_updated_at" BEFORE UPDATE ON "public"."owner_change_log_entries" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_customer_ready_gates_updated_at" BEFORE UPDATE ON "public"."owner_customer_ready_gates" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_gus_validation_results_updated_at" BEFORE UPDATE ON "public"."owner_gus_validation_results" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_gus_validation_test_cases_updated_at" BEFORE UPDATE ON "public"."owner_gus_validation_test_cases" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_manual_review_items_updated_at" BEFORE UPDATE ON "public"."owner_manual_review_items" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_registry_updated_at" BEFORE UPDATE ON "public"."owner_registry" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_owner_validation_modules_updated_at" BEFORE UPDATE ON "public"."owner_validation_modules" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "set_platform_help_tickets_updated_at" BEFORE UPDATE ON "public"."platform_help_tickets" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
ALTER TABLE ONLY "public"."ai_engine_events"
    ADD CONSTRAINT "ai_engine_events_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_engine_events"
    ADD CONSTRAINT "ai_engine_events_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_events"
    ADD CONSTRAINT "ai_engine_events_edge_id_fkey" FOREIGN KEY ("edge_id") REFERENCES "public"."ai_knowledge_edges"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_events"
    ADD CONSTRAINT "ai_engine_events_node_id_fkey" FOREIGN KEY ("node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_edge_id_fkey" FOREIGN KEY ("edge_id") REFERENCES "public"."ai_knowledge_edges"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_node_id_fkey" FOREIGN KEY ("node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_engine_validation_logs"
    ADD CONSTRAINT "ai_engine_validation_logs_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_improvement_audit_events"
    ADD CONSTRAINT "ai_improvement_audit_events_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_improvement_audit_events"
    ADD CONSTRAINT "ai_improvement_audit_events_improvement_request_id_fkey" FOREIGN KEY ("improvement_request_id") REFERENCES "public"."ai_improvement_requests"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_improvement_requests"
    ADD CONSTRAINT "ai_improvement_requests_approved_by_super_admin_id_fkey" FOREIGN KEY ("approved_by_super_admin_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_improvement_requests"
    ADD CONSTRAINT "ai_improvement_requests_proposed_by_fkey" FOREIGN KEY ("proposed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_improvement_requests"
    ADD CONSTRAINT "ai_improvement_requests_rejected_by_super_admin_id_fkey" FOREIGN KEY ("rejected_by_super_admin_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_from_node_id_fkey" FOREIGN KEY ("from_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_source_node_id_fkey" FOREIGN KEY ("source_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_target_node_id_fkey" FOREIGN KEY ("target_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_edges"
    ADD CONSTRAINT "ai_knowledge_edges_to_node_id_fkey" FOREIGN KEY ("to_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_batches"
    ADD CONSTRAINT "ai_knowledge_ingest_batches_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_batches"
    ADD CONSTRAINT "ai_knowledge_ingest_batches_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_batch_id_fkey" FOREIGN KEY ("batch_id") REFERENCES "public"."ai_knowledge_ingest_batches"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_promoted_edge_id_fkey" FOREIGN KEY ("promoted_edge_id") REFERENCES "public"."ai_knowledge_edges"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_promoted_node_id_fkey" FOREIGN KEY ("promoted_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_ingest_candidates"
    ADD CONSTRAINT "ai_knowledge_ingest_candidates_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_knowledge_map_views"
    ADD CONSTRAINT "ai_knowledge_map_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_knowledge_nodes"
    ADD CONSTRAINT "ai_knowledge_nodes_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_vector_memory"
    ADD CONSTRAINT "ai_vector_memory_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_vector_memory"
    ADD CONSTRAINT "ai_vector_memory_knowledge_node_id_fkey" FOREIGN KEY ("knowledge_node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_vector_memory"
    ADD CONSTRAINT "ai_vector_memory_node_id_fkey" FOREIGN KEY ("node_id") REFERENCES "public"."ai_knowledge_nodes"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_approved_by_fkey" FOREIGN KEY ("approved_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_approved_source_id_fkey" FOREIGN KEY ("approved_source_id") REFERENCES "public"."approved_sources"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_research_queue_id_fkey" FOREIGN KEY ("research_queue_id") REFERENCES "public"."research_queue"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_superseded_by_knowledge_id_fkey" FOREIGN KEY ("superseded_by_knowledge_id") REFERENCES "public"."approved_knowledge"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_knowledge"
    ADD CONSTRAINT "approved_knowledge_supersedes_knowledge_id_fkey" FOREIGN KEY ("supersedes_knowledge_id") REFERENCES "public"."approved_knowledge"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."approved_sources"
    ADD CONSTRAINT "approved_sources_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."approved_sources"
    ADD CONSTRAINT "approved_sources_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."change_log"
    ADD CONSTRAINT "change_log_changed_by_user_id_fkey" FOREIGN KEY ("changed_by_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."change_log"
    ADD CONSTRAINT "change_log_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."change_log"
    ADD CONSTRAINT "change_log_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."change_log"
    ADD CONSTRAINT "change_log_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."owner_registry"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."company_jobsite_emergency_defaults"
    ADD CONSTRAINT "company_jobsite_emergency_defaults_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."company_jobsite_emergency_defaults"
    ADD CONSTRAINT "company_jobsite_emergency_defaults_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."company_jobsite_emergency_defaults"
    ADD CONSTRAINT "company_jobsite_emergency_defaults_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_last_reviewed_by_fkey" FOREIGN KEY ("last_reviewed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."company_jobsite_emergency_profiles"
    ADD CONSTRAINT "company_jobsite_emergency_profiles_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."event_log"
    ADD CONSTRAINT "event_log_actor_user_id_fkey" FOREIGN KEY ("actor_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."event_log"
    ADD CONSTRAINT "event_log_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."event_log"
    ADD CONSTRAINT "event_log_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."event_log"
    ADD CONSTRAINT "event_log_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."owner_registry"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_answer_audit"
    ADD CONSTRAINT "gus_answer_audit_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gus_answer_audit"
    ADD CONSTRAINT "gus_answer_audit_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_answer_audit"
    ADD CONSTRAINT "gus_answer_audit_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_answer_feedback"
    ADD CONSTRAINT "gus_answer_feedback_answer_audit_id_fkey" FOREIGN KEY ("answer_audit_id") REFERENCES "public"."gus_answer_audit"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_answer_feedback"
    ADD CONSTRAINT "gus_answer_feedback_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gus_answer_feedback"
    ADD CONSTRAINT "gus_answer_feedback_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_answer_feedback"
    ADD CONSTRAINT "gus_answer_feedback_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_answer_audit_id_fkey" FOREIGN KEY ("answer_audit_id") REFERENCES "public"."gus_answer_audit"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_feedback_id_fkey" FOREIGN KEY ("feedback_id") REFERENCES "public"."gus_answer_feedback"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."gus_learning_review_items"
    ADD CONSTRAINT "gus_learning_review_items_resolved_by_fkey" FOREIGN KEY ("resolved_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."health_score_snapshots"
    ADD CONSTRAINT "health_score_snapshots_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."health_score_snapshots"
    ADD CONSTRAINT "health_score_snapshots_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."knowledge_change_log"
    ADD CONSTRAINT "knowledge_change_log_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."knowledge_change_log"
    ADD CONSTRAINT "knowledge_change_log_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."knowledge_change_log"
    ADD CONSTRAINT "knowledge_change_log_knowledge_id_fkey" FOREIGN KEY ("knowledge_id") REFERENCES "public"."approved_knowledge"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."owner_change_log_entries"
    ADD CONSTRAINT "owner_change_log_entries_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_customer_ready_gates"
    ADD CONSTRAINT "owner_customer_ready_gates_approved_by_fkey" FOREIGN KEY ("approved_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_customer_ready_gates"
    ADD CONSTRAINT "owner_customer_ready_gates_latest_owner_proof_report_id_fkey" FOREIGN KEY ("latest_owner_proof_report_id") REFERENCES "public"."owner_validation_runs"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_customer_ready_gates"
    ADD CONSTRAINT "owner_customer_ready_gates_module_key_fkey" FOREIGN KEY ("module_key") REFERENCES "public"."owner_validation_modules"("module_key") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_gus_validation_results"
    ADD CONSTRAINT "owner_gus_validation_results_approved_by_fkey" FOREIGN KEY ("approved_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_gus_validation_results"
    ADD CONSTRAINT "owner_gus_validation_results_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_gus_validation_results"
    ADD CONSTRAINT "owner_gus_validation_results_flagged_by_fkey" FOREIGN KEY ("flagged_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_gus_validation_results"
    ADD CONSTRAINT "owner_gus_validation_results_test_case_id_fkey" FOREIGN KEY ("test_case_id") REFERENCES "public"."owner_gus_validation_test_cases"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_gus_validation_test_cases"
    ADD CONSTRAINT "owner_gus_validation_test_cases_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_manual_review_items"
    ADD CONSTRAINT "owner_manual_review_items_completed_by_fkey" FOREIGN KEY ("completed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_manual_review_items"
    ADD CONSTRAINT "owner_manual_review_items_module_key_fkey" FOREIGN KEY ("module_key") REFERENCES "public"."owner_validation_modules"("module_key") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_registry"
    ADD CONSTRAINT "owner_registry_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_registry"
    ADD CONSTRAINT "owner_registry_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_registry"
    ADD CONSTRAINT "owner_registry_owner_user_id_fkey" FOREIGN KEY ("owner_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_validation_check_results"
    ADD CONSTRAINT "owner_validation_check_results_module_key_fkey" FOREIGN KEY ("module_key") REFERENCES "public"."owner_validation_modules"("module_key") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_validation_check_results"
    ADD CONSTRAINT "owner_validation_check_results_run_id_fkey" FOREIGN KEY ("run_id") REFERENCES "public"."owner_validation_runs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."owner_validation_modules"
    ADD CONSTRAINT "owner_validation_modules_last_tested_by_fkey" FOREIGN KEY ("last_tested_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_validation_runs"
    ADD CONSTRAINT "owner_validation_runs_started_by_fkey" FOREIGN KEY ("started_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_validation_sandbox_records"
    ADD CONSTRAINT "owner_validation_sandbox_records_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."owner_validation_sandbox_records"
    ADD CONSTRAINT "owner_validation_sandbox_records_sandbox_company_id_fkey" FOREIGN KEY ("sandbox_company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_assigned_superadmin_user_id_fkey" FOREIGN KEY ("assigned_superadmin_user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_jobsite_id_fkey" FOREIGN KEY ("jobsite_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "public"."owner_registry"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_submitter_user_id_fkey" FOREIGN KEY ("submitter_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."platform_help_tickets"
    ADD CONSTRAINT "platform_help_tickets_superadmin_seen_by_fkey" FOREIGN KEY ("superadmin_seen_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."research_queue"
    ADD CONSTRAINT "research_queue_approved_source_id_fkey" FOREIGN KEY ("approved_source_id") REFERENCES "public"."approved_sources"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."research_queue"
    ADD CONSTRAINT "research_queue_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."research_queue"
    ADD CONSTRAINT "research_queue_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "public"."company_jobsites"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."research_queue"
    ADD CONSTRAINT "research_queue_requested_by_fkey" FOREIGN KEY ("requested_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."research_queue"
    ADD CONSTRAINT "research_queue_reviewer_id_fkey" FOREIGN KEY ("reviewer_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
CREATE POLICY "Users can insert own agreement acceptance" ON "public"."user_agreements" FOR INSERT WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can read own agreement acceptance" ON "public"."user_agreements" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "Users can update own agreement acceptance" ON "public"."user_agreements" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "ai_improvement_audit_events_super_admin_select" ON "public"."ai_improvement_audit_events" FOR SELECT TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "ai_improvement_requests_super_admin_only" ON "public"."ai_improvement_requests" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "approved_knowledge_select_active_scope" ON "public"."approved_knowledge" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("is_active" = true) AND (("company_id" IS NULL) OR "public"."security_is_company_member"("company_id")))));
...
CREATE POLICY "approved_sources_select_active_scope" ON "public"."approved_sources" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("is_active" = true) AND ("trust_level" <> 'blocked'::"public"."gus_learning_trust_level") AND (("company_id" IS NULL) OR "public"."security_is_company_member"("company_id")))));
...
CREATE POLICY "behavior_risk_events_insert_scope" ON "public"."behavior_risk_events" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id"))))));
...
CREATE POLICY "behavior_risk_events_update_scope" ON "public"."behavior_risk_events" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "behavior_risk_events"."company_id"))))));
...
CREATE POLICY "billing_invoice_counters_service_role_all" ON "public"."billing_invoice_counters" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "change_log_insert_superadmin_or_company" ON "public"."change_log" FOR INSERT TO "authenticated" WITH CHECK ((("public"."current_app_role"() = 'super_admin'::"text") OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));



CREATE POLICY "change_log_select_superadmin_or_company" ON "public"."change_log" FOR SELECT TO "authenticated" USING ((("public"."current_app_role"() = 'super_admin'::"text") OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));
...
CREATE POLICY "company_contractor_documents_insert_scope" ON "public"."company_contractor_documents" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id"))))));
...
CREATE POLICY "company_contractor_documents_update_scope" ON "public"."company_contractor_documents" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_documents"."company_id"))))));
...
CREATE POLICY "company_contractor_evaluations_insert_scope" ON "public"."company_contractor_evaluations" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_evaluations"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractor_evaluations"."company_id"))))));
...
CREATE POLICY "company_contractors_insert_scope" ON "public"."company_contractors" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id"))))));
...
CREATE POLICY "company_contractors_update_scope" ON "public"."company_contractors" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_contractors"."company_id"))))));
...
CREATE POLICY "company_corrective_actions_delete_company_scope" ON "public"."company_corrective_actions" FOR DELETE USING (("public"."security_is_company_manager"("company_id") AND "public"."security_has_jobsite_access"("company_id", "jobsite_id")));
...
CREATE POLICY "company_crews_insert_scope" ON "public"."company_crews" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id"))))));
...
CREATE POLICY "company_crews_update_scope" ON "public"."company_crews" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_crews"."company_id"))))));
...
CREATE POLICY "company_data_requests_insert_manager_scope" ON "public"."company_data_requests" FOR INSERT TO "authenticated" WITH CHECK (((( SELECT "auth"."uid"() AS "uid") IS NOT NULL) AND "public"."security_is_company_manager"("company_id")));
...
CREATE POLICY "company_hris_roster_imports_insert_scope" ON "public"."company_hris_roster_imports" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_hris_roster_imports"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_hris_roster_imports"."company_id"))))));
...
CREATE POLICY "company_incidents_delete_company_scope" ON "public"."company_incidents" FOR DELETE USING (("public"."security_is_company_manager"("company_id") AND "public"."security_has_jobsite_access"("company_id", "jobsite_id")));
...
CREATE POLICY "company_induction_completions_insert_scope" ON "public"."company_induction_completions" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id"))))));
...
CREATE POLICY "company_induction_completions_update_scope" ON "public"."company_induction_completions" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_completions"."company_id"))))));
...
CREATE POLICY "company_induction_programs_insert_scope" ON "public"."company_induction_programs" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id"))))));
...
CREATE POLICY "company_induction_programs_update_scope" ON "public"."company_induction_programs" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_programs"."company_id"))))));
...
CREATE POLICY "company_induction_requirements_insert_scope" ON "public"."company_induction_requirements" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id"))))));
...
CREATE POLICY "company_induction_requirements_update_scope" ON "public"."company_induction_requirements" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_induction_requirements"."company_id"))))));
...
CREATE POLICY "company_integration_webhook_deliveries_insert_scope" ON "public"."company_integration_webhook_deliveries" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhook_deliveries"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhook_deliveries"."company_id"))))));
...
CREATE POLICY "company_integration_webhooks_insert_scope" ON "public"."company_integration_webhooks" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id"))))));
...
CREATE POLICY "company_integration_webhooks_update_scope" ON "public"."company_integration_webhooks" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_integration_webhooks"."company_id"))))));
...
CREATE POLICY "company_jobsite_chemicals_insert_scope" ON "public"."company_jobsite_chemicals" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id"))))));
...
CREATE POLICY "company_jobsite_chemicals_update_scope" ON "public"."company_jobsite_chemicals" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_chemicals"."company_id"))))));
...
CREATE POLICY "company_jobsite_daily_todos_insert_scope" ON "public"."company_jobsite_daily_todos" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id"))))));
...
CREATE POLICY "company_jobsite_daily_todos_update_scope" ON "public"."company_jobsite_daily_todos" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jobsite_daily_todos"."company_id"))))));
...
CREATE POLICY "company_jobsite_emergency_defaults_delete_scope" ON "public"."company_jobsite_emergency_defaults" FOR DELETE TO "authenticated" USING ("public"."security_can_write_company_data"("company_id"));



CREATE POLICY "company_jobsite_emergency_defaults_insert_scope" ON "public"."company_jobsite_emergency_defaults" FOR INSERT TO "authenticated" WITH CHECK ("public"."security_can_write_company_data"("company_id"));



CREATE POLICY "company_jobsite_emergency_defaults_select_scope" ON "public"."company_jobsite_emergency_defaults" FOR SELECT TO "authenticated" USING ("public"."security_is_company_member"("company_id"));



CREATE POLICY "company_jobsite_emergency_defaults_update_scope" ON "public"."company_jobsite_emergency_defaults" FOR UPDATE TO "authenticated" USING ("public"."security_is_company_member"("company_id")) WITH CHECK ("public"."security_can_write_company_data"("company_id"));
...
CREATE POLICY "company_jobsite_emergency_profiles_delete_scope" ON "public"."company_jobsite_emergency_profiles" FOR DELETE TO "authenticated" USING ("public"."security_can_write_company_data"("company_id"));



CREATE POLICY "company_jobsite_emergency_profiles_insert_scope" ON "public"."company_jobsite_emergency_profiles" FOR INSERT TO "authenticated" WITH CHECK (("public"."security_can_write_company_data"("company_id") AND (EXISTS ( SELECT 1
   FROM "public"."company_jobsites" "jobsite"
  WHERE (("jobsite"."id" = "company_jobsite_emergency_profiles"."jobsite_id") AND ("jobsite"."company_id" = "company_jobsite_emergency_profiles"."company_id"))))));



CREATE POLICY "company_jobsite_emergency_profiles_select_scope" ON "public"."company_jobsite_emergency_profiles" FOR SELECT TO "authenticated" USING ("public"."security_is_company_member"("company_id"));



CREATE POLICY "company_jobsite_emergency_profiles_update_scope" ON "public"."company_jobsite_emergency_profiles" FOR UPDATE TO "authenticated" USING ("public"."security_is_company_member"("company_id")) WITH CHECK (("public"."security_can_write_company_data"("company_id") AND (EXISTS ( SELECT 1
   FROM "public"."company_jobsites" "jobsite"
  WHERE (("jobsite"."id" = "company_jobsite_emergency_profiles"."jobsite_id") AND ("jobsite"."company_id" = "company_jobsite_emergency_profiles"."company_id"))))));
...
CREATE POLICY "company_jsa_activities_scope" ON "public"."company_jsa_activities" TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsa_activities"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsa_activities"."company_id") AND ("actor"."account_status" = 'active'::"text")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsa_activities"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsa_activities"."company_id") AND ("actor"."account_status" = 'active'::"text"))))));
...
CREATE POLICY "company_jsas_insert_scope" ON "public"."company_jsas" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id"))))));
...
CREATE POLICY "company_jsas_update_scope" ON "public"."company_jsas" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_jsas"."company_id"))))));
...
CREATE POLICY "company_leadership_safety_scores_insert_managers" ON "public"."company_leadership_safety_scores" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));



CREATE POLICY "company_leadership_safety_scores_select_scope" ON "public"."company_leadership_safety_scores" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (( SELECT "auth"."uid"() AS "uid") = "user_id") OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text", 'project_manager'::"text", 'field_supervisor'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text", 'project_manager'::"text", 'field_supervisor'::"text"])))))));
...
CREATE POLICY "company_leadership_safety_scores_update_managers" ON "public"."company_leadership_safety_scores" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_leadership_safety_scores"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "company_notification_preferences_insert_self" ON "public"."company_notification_preferences" FOR INSERT TO "authenticated" WITH CHECK ((("user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notification_preferences"."company_id") AND ("actor"."status" = 'active'::"text"))))));



CREATE POLICY "company_notification_preferences_select_self_or_admin" ON "public"."company_notification_preferences" FOR SELECT TO "authenticated" USING ((("user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notification_preferences"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notification_preferences"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));



CREATE POLICY "company_notification_preferences_update_self" ON "public"."company_notification_preferences" FOR UPDATE TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "company_notifications_insert_company_scope" ON "public"."company_notifications" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR ("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."status" = 'active'::"text")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id"))))));



CREATE POLICY "company_notifications_select_recipient_or_admin" ON "public"."company_notifications" FOR SELECT TO "authenticated" USING ((("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));



CREATE POLICY "company_notifications_update_recipient_or_admin" ON "public"."company_notifications" FOR UPDATE TO "authenticated" USING ((("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))))) WITH CHECK ((("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_notifications"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "company_permits_delete_company_scope" ON "public"."company_permits" FOR DELETE USING (("public"."security_is_company_manager"("company_id") AND "public"."security_has_jobsite_access"("company_id", "jobsite_id")));
...
CREATE POLICY "company_risk_ai_recommendations_insert_scope" ON "public"."company_risk_ai_recommendations" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id"))))));
...
CREATE POLICY "company_risk_ai_recommendations_update_scope" ON "public"."company_risk_ai_recommendations" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_ai_recommendations"."company_id"))))));
...
CREATE POLICY "company_risk_memory_facets_delete_scope" ON "public"."company_risk_memory_facets" FOR DELETE USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id"))))));
...
CREATE POLICY "company_risk_memory_facets_select_scope" ON "public"."company_risk_memory_facets" FOR SELECT USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id"))))));
...
CREATE POLICY "company_risk_memory_facets_update_scope" ON "public"."company_risk_memory_facets" FOR UPDATE USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_facets"."company_id"))))));
...
CREATE POLICY "company_risk_memory_snapshots_insert_scope" ON "public"."company_risk_memory_snapshots" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id"))))));
...
CREATE POLICY "company_risk_memory_snapshots_update_scope" ON "public"."company_risk_memory_snapshots" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_memory_snapshots"."company_id"))))));
...
CREATE POLICY "company_risk_recommendation_events_insert_scope" ON "public"."company_risk_recommendation_events" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_recommendation_events"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_risk_recommendation_events"."company_id"))))));
...
CREATE POLICY "company_safety_form_definitions_insert_scope" ON "public"."company_safety_form_definitions" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id"))))));
...
CREATE POLICY "company_safety_form_definitions_update_scope" ON "public"."company_safety_form_definitions" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_definitions"."company_id"))))));
...
CREATE POLICY "company_safety_form_submissions_insert_scope" ON "public"."company_safety_form_submissions" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id"))))));
...
CREATE POLICY "company_safety_form_submissions_update_scope" ON "public"."company_safety_form_submissions" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_submissions"."company_id"))))));
...
CREATE POLICY "company_safety_form_versions_insert_scope" ON "public"."company_safety_form_versions" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_versions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_safety_form_versions"."company_id"))))));
...
CREATE POLICY "company_security_events_insert_member_scope" ON "public"."company_security_events" FOR INSERT TO "authenticated" WITH CHECK (((( SELECT "auth"."uid"() AS "uid") IS NOT NULL) AND "public"."security_is_company_member"("company_id")));
...
CREATE POLICY "company_toolbox_attendees_insert_scope" ON "public"."company_toolbox_attendees" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id"))))));
...
CREATE POLICY "company_toolbox_attendees_update_scope" ON "public"."company_toolbox_attendees" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_attendees"."company_id"))))));
...
CREATE POLICY "company_toolbox_sessions_insert_scope" ON "public"."company_toolbox_sessions" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id"))))));
...
CREATE POLICY "company_toolbox_sessions_update_scope" ON "public"."company_toolbox_sessions" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_sessions"."company_id"))))));
...
CREATE POLICY "company_toolbox_templates_insert_scope" ON "public"."company_toolbox_templates" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id"))))));
...
CREATE POLICY "company_toolbox_templates_update_scope" ON "public"."company_toolbox_templates" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
  ...
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_toolbox_templates"."company_id"))))));
...
CREATE POLICY "company_training_requirements_delete_lead" ON "public"."company_training_requirements" FOR DELETE USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."company_id" = "company_training_requirements"."company_id") AND ("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (COALESCE("m"."status", ''::"text") = 'active'::"text") AND (COALESCE("m"."role", ''::"text") = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "company_training_requirements_insert_lead" ON "public"."company_training_requirements" FOR INSERT TO "authenticated" WITH CHECK (((EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."company_id" = "company_training_requirements"."company_id") AND ("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (COALESCE("m"."status", ''::"text") = 'active'::"text") AND (COALESCE("m"."role", ''::"text") = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR "public"."is_admin_role"()));



CREATE POLICY "company_training_requirements_select_member" ON "public"."company_training_requirements" FOR SELECT USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."company_id" = "company_training_requirements"."company_id") AND ("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (COALESCE("m"."status", ''::"text") = 'active'::"text"))))));



CREATE POLICY "company_training_requirements_update_lead" ON "public"."company_training_requirements" FOR UPDATE USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."company_id" = "company_training_requirements"."company_id") AND ("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (COALESCE("m"."status", ''::"text") = 'active'::"text") AND (COALESCE("m"."role", ''::"text") = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."company_id" = "company_training_requirements"."company_id") AND ("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND (COALESCE("m"."status", ''::"text") = 'active'::"text") AND (COALESCE("m"."role", ''::"text") = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "contractor_employee_intake_tokens_insert_scope" ON "public"."contractor_employee_intake_tokens" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (("created_by" = ( SELECT "auth"."uid"() AS "uid")) AND (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."id" = "contractor_employee_intake_tokens"."assignment_id") AND ("assignment"."company_id" = "contractor_employee_intake_tokens"."company_id") AND ("assignment"."jobsite_id" = "contractor_employee_intake_tokens"."jobsite_id") AND ("assignment"."contractor_employee_id" = "contractor_employee_intake_tokens"."contractor_employee_id") AND "public"."security_is_company_member"("assignment"."company_id")))))));



CREATE POLICY "contractor_employee_intake_tokens_select_scope" ON "public"."contractor_employee_intake_tokens" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."id" = "contractor_employee_intake_tokens"."assignment_id") AND "public"."security_is_company_member"("assignment"."company_id"))))));



CREATE POLICY "contractor_employee_intake_tokens_update_scope" ON "public"."contractor_employee_intake_tokens" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."id" = "contractor_employee_intake_tokens"."assignment_id") AND "public"."security_is_company_member"("assignment"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."id" = "contractor_employee_intake_tokens"."assignment_id") AND ("assignment"."company_id" = "contractor_employee_intake_tokens"."company_id") AND ("assignment"."jobsite_id" = "contractor_employee_intake_tokens"."jobsite_id") AND ("assignment"."contractor_employee_id" = "contractor_employee_intake_tokens"."contractor_employee_id") AND "public"."security_is_company_member"("assignment"."company_id"))))));
...
CREATE POLICY "contractor_employee_jobsite_assignments_company_scope" ON "public"."contractor_employee_jobsite_assignments" TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("m"."company_id" = "contractor_employee_jobsite_assignments"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "r"
  WHERE (("r"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("r"."company_id" = "contractor_employee_jobsite_assignments"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("m"."company_id" = "contractor_employee_jobsite_assignments"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "r"
  WHERE (("r"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("r"."company_id" = "contractor_employee_jobsite_assignments"."company_id"))))));
...
CREATE POLICY "contractor_employee_profiles_insert_own" ON "public"."contractor_employee_profiles" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR ("created_by" = ( SELECT "auth"."uid"() AS "uid"))));



CREATE POLICY "contractor_employee_profiles_select_scope" ON "public"."contractor_employee_profiles" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR ("created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."contractor_employee_id" = "contractor_employee_profiles"."id") AND "public"."security_is_company_member"("assignment"."company_id"))))));



CREATE POLICY "contractor_employee_profiles_update_scope" ON "public"."contractor_employee_profiles" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR ("created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."contractor_employee_id" = "contractor_employee_profiles"."id") AND "public"."security_is_company_member"("assignment"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR ("created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_jobsite_assignments" "assignment"
  WHERE (("assignment"."contractor_employee_id" = "contractor_employee_profiles"."id") AND "public"."security_is_company_member"("assignment"."company_id"))))));
...
CREATE POLICY "contractor_employee_training_records_insert_scope" ON "public"."contractor_employee_training_records" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_profiles" "profile"
  WHERE (("profile"."id" = "contractor_employee_training_records"."contractor_employee_id") AND (("profile"."created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."contractor_employee_jobsite_assignments" "assignment"
          WHERE (("assignment"."contractor_employee_id" = "profile"."id") AND "public"."security_is_company_member"("assignment"."company_id"))))))))));



CREATE POLICY "contractor_employee_training_records_select_scope" ON "public"."contractor_employee_training_records" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_profiles" "profile"
  WHERE (("profile"."id" = "contractor_employee_training_records"."contractor_employee_id") AND (("profile"."created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."contractor_employee_jobsite_assignments" "assignment"
          WHERE (("assignment"."contractor_employee_id" = "profile"."id") AND "public"."security_is_company_member"("assignment"."company_id"))))))))));
...
CREATE POLICY "contractor_employee_training_records_update_scope" ON "public"."contractor_employee_training_records" FOR UPDATE TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_profiles" "profile"
  WHERE (("profile"."id" = "contractor_employee_training_records"."contractor_employee_id") AND (("profile"."created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."contractor_employee_jobsite_assignments" "assignment"
          WHERE (("assignment"."contractor_employee_id" = "profile"."id") AND "public"."security_is_company_member"("assignment"."company_id")))))))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."contractor_employee_profiles" "profile"
  WHERE (("profile"."id" = "contractor_employee_training_records"."contractor_employee_id") AND (("profile"."created_by" = ( SELECT "auth"."uid"() AS "uid")) OR (EXISTS ( SELECT 1
           FROM "public"."contractor_employee_jobsite_assignments" "assignment"
          WHERE (("assignment"."contractor_employee_id" = "profile"."id") AND "public"."security_is_company_member"("assignment"."company_id"))))))))));
...
CREATE POLICY "credit_transactions_select_own" ON "public"."credit_transactions" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "document_downloads_insert_own" ON "public"."document_downloads" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "actor_user_id"));



CREATE POLICY "document_downloads_select_own" ON "public"."document_downloads" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "actor_user_id") OR (( SELECT "auth"."uid"() AS "uid") = "owner_user_id")));
...
CREATE POLICY "documents_scope" ON "public"."documents" TO "authenticated" USING (("public"."is_admin_role"() OR (( SELECT "auth"."uid"() AS "uid") = "user_id") OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id") AND ("actor"."account_status" = 'active'::"text")))) OR (("lower"(COALESCE("status", ''::"text")) = 'approved'::"text") AND ("final_file_path" IS NOT NULL)))) WITH CHECK (("public"."is_admin_role"() OR ((( SELECT "auth"."uid"() AS "uid") = "user_id") AND (("company_id" IS NULL) OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id") AND ("actor"."account_status" = 'active'::"text")))))) OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "documents"."company_id") AND ("actor"."account_status" = 'active'::"text"))))));
...
CREATE POLICY "event_log_insert_superadmin_or_company" ON "public"."event_log" FOR INSERT TO "authenticated" WITH CHECK ((("public"."current_app_role"() = 'super_admin'::"text") OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));



CREATE POLICY "event_log_select_superadmin_or_company" ON "public"."event_log" FOR SELECT TO "authenticated" USING ((("public"."current_app_role"() = 'super_admin'::"text") OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));
...
CREATE POLICY "gus_answer_audit_select_scope" ON "public"."gus_answer_audit" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR ("user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (("company_id" IS NOT NULL) AND "public"."security_can_review_gus_learning"("company_id"))));
...
CREATE POLICY "gus_answer_feedback_select_review_scope" ON "public"."gus_answer_feedback" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("company_id" IS NOT NULL) AND "public"."security_can_review_gus_learning"("company_id")) OR ("user_id" = ( SELECT "auth"."uid"() AS "uid"))));
...
CREATE POLICY "gus_learning_review_items_select_scope" ON "public"."gus_learning_review_items" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("company_id" IS NOT NULL) AND "public"."security_can_review_gus_learning"("company_id"))));
...
CREATE POLICY "health_score_snapshots_insert_superadmin" ON "public"."health_score_snapshots" FOR INSERT TO "authenticated" WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));



CREATE POLICY "health_score_snapshots_select_superadmin_or_company" ON "public"."health_score_snapshots" FOR SELECT TO "authenticated" USING ((("public"."current_app_role"() = 'super_admin'::"text") OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));
...
CREATE POLICY "incident_notification_deliveries_select_scope" ON "public"."incident_notification_deliveries" FOR SELECT TO "authenticated" USING ((("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "incident_notification_deliveries"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "incident_notification_deliveries"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "injury_forecast_audit_log_insert_admin_scope" ON "public"."injury_forecast_audit_log" FOR INSERT TO "authenticated" WITH CHECK (("public"."is_admin_role"() OR (("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "injury_forecast_audit_log"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'admin'::"text", 'super_admin'::"text", 'platform_admin'::"text"])) AND ("actor"."account_status" = 'active'::"text")))))));
...
CREATE POLICY "injury_forecast_audit_log_select_scope" ON "public"."injury_forecast_audit_log" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "injury_forecast_audit_log"."company_id"))))) OR (("company_id" IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "injury_forecast_audit_log"."company_id") AND ("actor"."account_status" = 'active'::"text")))))));
...
CREATE POLICY "internal_jobsite_audits_insert_admin" ON "public"."internal_jobsite_audits" FOR INSERT TO "authenticated" WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "created_by_user_id") AND "public"."is_admin_role"()));
...
CREATE POLICY "jobsite_contractor_training_requirements_company_scope" ON "public"."jobsite_contractor_training_requirements" TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("m"."company_id" = "jobsite_contractor_training_requirements"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "r"
  WHERE (("r"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("r"."company_id" = "jobsite_contractor_training_requirements"."company_id")))))) WITH CHECK (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "m"
  WHERE (("m"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("m"."company_id" = "jobsite_contractor_training_requirements"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "r"
  WHERE (("r"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("r"."company_id" = "jobsite_contractor_training_requirements"."company_id"))))));
...
CREATE POLICY "jobsite_weather_subscriptions_delete_scope" ON "public"."jobsite_weather_subscriptions" FOR DELETE USING (("public"."security_is_company_manager"("company_id") OR (("user_id" = ( SELECT "auth"."uid"() AS "uid")) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id"))));



CREATE POLICY "jobsite_weather_subscriptions_insert_scope" ON "public"."jobsite_weather_subscriptions" FOR INSERT TO "authenticated" WITH CHECK ((("public"."security_is_company_manager"("company_id") OR ("user_id" = ( SELECT "auth"."uid"() AS "uid"))) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id") AND (EXISTS ( SELECT 1
   FROM "public"."company_jobsites" "jobsite"
...
CREATE POLICY "jobsite_weather_subscriptions_select_scope" ON "public"."jobsite_weather_subscriptions" FOR SELECT USING (("public"."security_is_company_manager"("company_id") OR (("user_id" = ( SELECT "auth"."uid"() AS "uid")) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id"))));



CREATE POLICY "jobsite_weather_subscriptions_update_scope" ON "public"."jobsite_weather_subscriptions" FOR UPDATE USING (("public"."security_is_company_manager"("company_id") OR (("user_id" = ( SELECT "auth"."uid"() AS "uid")) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id")))) WITH CHECK ((("public"."security_is_company_manager"("company_id") OR ("user_id" = ( SELECT "auth"."uid"() AS "uid"))) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id") AND (EXISTS ( SELECT 1
   FROM "public"."company_jobsites" "jobsite"
  WHERE (("jobsite"."id" = "jobsite_weather_subscriptions"."jobsite_id") AND ("jobsite"."company_id" = "jobsite_weather_subscriptions"."company_id"))))));
...
CREATE POLICY "knowledge_change_log_select_admin_scope" ON "public"."knowledge_change_log" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (("company_id" IS NOT NULL) AND "public"."security_can_approve_gus_learning"("company_id"))));
...
CREATE POLICY "osha_predictability_baselines_service_role_all" ON "public"."osha_predictability_baselines" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "owner_change_log_entries_super_admin_only" ON "public"."owner_change_log_entries" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_customer_ready_gates_super_admin_only" ON "public"."owner_customer_ready_gates" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_gus_validation_results_super_admin_only" ON "public"."owner_gus_validation_results" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_gus_validation_test_cases_super_admin_only" ON "public"."owner_gus_validation_test_cases" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_manual_review_items_super_admin_only" ON "public"."owner_manual_review_items" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_registry_insert_superadmin" ON "public"."owner_registry" FOR INSERT TO "authenticated" WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));



CREATE POLICY "owner_registry_select_superadmin_or_company" ON "public"."owner_registry" FOR SELECT TO "authenticated" USING ((("public"."current_app_role"() = 'super_admin'::"text") OR ("owner_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR (("company_id" IS NOT NULL) AND "public"."security_is_company_member"("company_id"))));



CREATE POLICY "owner_registry_update_superadmin" ON "public"."owner_registry" FOR UPDATE TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_validation_check_results_super_admin_only" ON "public"."owner_validation_check_results" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_validation_modules_super_admin_only" ON "public"."owner_validation_modules" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_validation_runs_super_admin_only" ON "public"."owner_validation_runs" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "owner_validation_sandbox_records_super_admin_only" ON "public"."owner_validation_sandbox_records" TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "platform_help_tickets_insert_own" ON "public"."platform_help_tickets" FOR INSERT TO "authenticated" WITH CHECK (("submitter_user_id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "platform_help_tickets_select_submitter_or_superadmin" ON "public"."platform_help_tickets" FOR SELECT TO "authenticated" USING ((("submitter_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR ("public"."current_app_role"() = 'super_admin'::"text")));



CREATE POLICY "platform_help_tickets_update_superadmin" ON "public"."platform_help_tickets" FOR UPDATE TO "authenticated" USING (("public"."current_app_role"() = 'super_admin'::"text")) WITH CHECK (("public"."current_app_role"() = 'super_admin'::"text"));
...
CREATE POLICY "platform_predictability_aggregates_service_role_all" ON "public"."platform_predictability_aggregates" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "pshsep_attachments_delete_own" ON "public"."pshsep_attachments" FOR DELETE TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_attachments_insert_own" ON "public"."pshsep_attachments" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_attachments_select_own" ON "public"."pshsep_attachments" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "pshsep_drafts_delete_own" ON "public"."pshsep_drafts" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_drafts_insert_own" ON "public"."pshsep_drafts" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_drafts_select_own" ON "public"."pshsep_drafts" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_drafts_update_own" ON "public"."pshsep_drafts" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "pshsep_submissions_insert_own" ON "public"."pshsep_submissions" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "pshsep_submissions_select_own" ON "public"."pshsep_submissions" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "research_queue_select_review_scope" ON "public"."research_queue" FOR SELECT TO "authenticated" USING ("public"."security_can_review_gus_learning"("company_id"));
...
CREATE POLICY "sor_admin_supersede_locked" ON "public"."company_sor_records" FOR UPDATE USING ((("status" = ANY (ARRAY['submitted'::"text", 'locked'::"text"])) AND ("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_sor_records"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'admin'::"text", 'super_admin'::"text", 'platform_admin'::"text"])) AND ("actor"."account_status" = 'active'::"text"))))))) WITH CHECK (("status" = ANY (ARRAY['submitted'::"text", 'locked'::"text", 'superseded'::"text"])));
...
CREATE POLICY "sor_audit_log_select_company_scope" ON "public"."sor_audit_log" FOR SELECT TO "authenticated" USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "sor_audit_log"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "sor_audit_log"."company_id") AND ("actor"."account_status" = 'active'::"text"))))));



CREATE POLICY "sor_insert_company_scope" ON "public"."company_sor_records" FOR INSERT TO "authenticated" WITH CHECK ((("created_by" = ( SELECT "auth"."uid"() AS "uid")) AND ("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_sor_records"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_sor_records"."company_id") AND ("actor"."account_status" = 'active'::"text")))))));



CREATE POLICY "sor_select_company_scope" ON "public"."company_sor_records" FOR SELECT USING (("public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_sor_records"."company_id")))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "company_sor_records"."company_id") AND ("actor"."account_status" = 'active'::"text"))))));
...
CREATE POLICY "sor_update_own_draft_only" ON "public"."company_sor_records" FOR UPDATE USING ((("created_by" = ( SELECT "auth"."uid"() AS "uid")) AND ("status" = 'draft'::"text"))) WITH CHECK ((("created_by" = ( SELECT "auth"."uid"() AS "uid")) AND ("status" = 'draft'::"text")));
...
CREATE POLICY "submissions_insert_own" ON "public"."user_submissions" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "submissions_select_own" ON "public"."user_submissions" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "submissions_update_own_or_admin" ON "public"."submissions" FOR UPDATE TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"())) WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"()));
...
CREATE POLICY "training_expiration_deliveries_select_scope" ON "public"."training_expiration_notification_deliveries" FOR SELECT TO "authenticated" USING ((("recipient_user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM "public"."company_memberships" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "training_expiration_notification_deliveries"."company_id") AND ("actor"."status" = 'active'::"text") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"]))))) OR (EXISTS ( SELECT 1
   FROM "public"."user_roles" "actor"
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."company_id" = "training_expiration_notification_deliveries"."company_id") AND ("actor"."role" = ANY (ARRAY['company_admin'::"text", 'manager'::"text", 'safety_manager'::"text"])))))));
...
CREATE POLICY "user_dashboard_layouts_delete_self" ON "public"."user_dashboard_layouts" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_dashboard_layouts_insert_self" ON "public"."user_dashboard_layouts" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_dashboard_layouts_select_self" ON "public"."user_dashboard_layouts" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_dashboard_layouts_update_self" ON "public"."user_dashboard_layouts" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "user_onboarding_state_delete_self" ON "public"."user_onboarding_state" FOR DELETE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_onboarding_state_insert_self" ON "public"."user_onboarding_state" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_onboarding_state_select_self" ON "public"."user_onboarding_state" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "user_onboarding_state_update_self" ON "public"."user_onboarding_state" FOR UPDATE USING ((( SELECT "auth"."uid"() AS "uid") = "user_id")) WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "user_profiles_insert_self" ON "public"."user_profiles" FOR INSERT TO "authenticated" WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM ("public"."company_memberships" "actor"
     JOIN "public"."company_memberships" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("target"."user_id" = "user_profiles"."user_id")))) OR (EXISTS ( SELECT 1
   FROM ("public"."user_roles" "actor"
     JOIN "public"."user_roles" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("actor"."company_id" IS NOT NULL) AND ("target"."user_id" = "user_profiles"."user_id"))))));



CREATE POLICY "user_profiles_select_self_or_admin" ON "public"."user_profiles" FOR SELECT TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM ("public"."company_memberships" "actor"
     JOIN "public"."company_memberships" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("target"."user_id" = "user_profiles"."user_id")))) OR (EXISTS ( SELECT 1
   FROM ("public"."user_roles" "actor"
...
CREATE POLICY "user_profiles_update_self" ON "public"."user_profiles" FOR UPDATE TO "authenticated" USING (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM ("public"."company_memberships" "actor"
     JOIN "public"."company_memberships" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("target"."user_id" = "user_profiles"."user_id")))) OR (EXISTS ( SELECT 1
   FROM ("public"."user_roles" "actor"
     JOIN "public"."user_roles" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("actor"."company_id" IS NOT NULL) AND ("target"."user_id" = "user_profiles"."user_id")))))) WITH CHECK (((( SELECT "auth"."uid"() AS "uid") = "user_id") OR "public"."is_admin_role"() OR (EXISTS ( SELECT 1
   FROM ("public"."company_memberships" "actor"
     JOIN "public"."company_memberships" "target" ON (("target"."company_id" = "actor"."company_id")))
  WHERE (("actor"."user_id" = ( SELECT "auth"."uid"() AS "uid")) AND ("actor"."role" = 'company_admin'::"text") AND ("target"."user_id" = "user_profiles"."user_id")))) OR (EXISTS ( SELECT 1
   FROM ("public"."user_roles" "actor"
...
CREATE POLICY "users can create own peshep submissions" ON "public"."peshep_submissions" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "users can create own submissions" ON "public"."submissions" FOR INSERT TO "authenticated" WITH CHECK ((( SELECT "auth"."uid"() AS "uid") = "user_id"));



CREATE POLICY "users can view own peshep submissions" ON "public"."peshep_submissions" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "weather_notification_deliveries_select_scope" ON "public"."weather_notification_deliveries" FOR SELECT TO "authenticated" USING (("public"."security_is_company_manager"("company_id") OR (("user_id" = ( SELECT "auth"."uid"() AS "uid")) AND "public"."security_has_jobsite_access"("company_id", "jobsite_id"))));
...
REVOKE ALL ON FUNCTION "public"."match_approved_knowledge"("p_company_id" "uuid", "p_project_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."match_approved_knowledge"("p_company_id" "uuid", "p_project_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_approved_knowledge"("p_company_id" "uuid", "p_project_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) TO "service_role";



REVOKE ALL ON FUNCTION "public"."match_company_memory_items"("p_company_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."match_company_memory_items"("p_company_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."match_company_memory_items"("p_company_id" "uuid", "p_query_embedding" "extensions"."vector", "p_match_count" integer) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."security_can_approve_gus_learning"("target_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."security_can_approve_gus_learning"("target_company_id" "uuid") TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."security_can_review_gus_learning"("target_company_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."security_can_review_gus_learning"("target_company_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_engine_events" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_engine_validation_logs" TO "service_role";



GRANT ALL ON TABLE "public"."ai_improvement_audit_events" TO "service_role";
GRANT SELECT ON TABLE "public"."ai_improvement_audit_events" TO "authenticated";



GRANT ALL ON TABLE "public"."ai_improvement_requests" TO "service_role";
GRANT SELECT,INSERT,UPDATE ON TABLE "public"."ai_improvement_requests" TO "authenticated";



GRANT ALL ON TABLE "public"."ai_knowledge_edges" TO "service_role";



GRANT ALL ON TABLE "public"."ai_knowledge_ingest_batches" TO "service_role";



GRANT ALL ON TABLE "public"."ai_knowledge_ingest_candidates" TO "service_role";



GRANT ALL ON TABLE "public"."ai_knowledge_map_views" TO "service_role";



GRANT ALL ON TABLE "public"."ai_knowledge_nodes" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_vector_memory" TO "service_role";
...
GRANT ALL ON TABLE "public"."approved_knowledge" TO "service_role";
GRANT SELECT ON TABLE "public"."approved_knowledge" TO "authenticated";



GRANT ALL ON TABLE "public"."approved_sources" TO "service_role";
GRANT SELECT ON TABLE "public"."approved_sources" TO "authenticated";
...
GRANT ALL ON TABLE "public"."company_jobsite_emergency_defaults" TO "anon";
GRANT ALL ON TABLE "public"."company_jobsite_emergency_defaults" TO "authenticated";
GRANT ALL ON TABLE "public"."company_jobsite_emergency_defaults" TO "service_role";



GRANT ALL ON TABLE "public"."company_jobsite_emergency_profiles" TO "anon";
GRANT ALL ON TABLE "public"."company_jobsite_emergency_profiles" TO "authenticated";
GRANT ALL ON TABLE "public"."company_jobsite_emergency_profiles" TO "service_role";
...
GRANT ALL ON TABLE "public"."gus_answer_audit" TO "service_role";
GRANT SELECT ON TABLE "public"."gus_answer_audit" TO "authenticated";



GRANT ALL ON TABLE "public"."gus_answer_feedback" TO "service_role";
GRANT SELECT ON TABLE "public"."gus_answer_feedback" TO "authenticated";
...
GRANT ALL ON TABLE "public"."gus_learning_review_items" TO "service_role";
GRANT SELECT ON TABLE "public"."gus_learning_review_items" TO "authenticated";
...
GRANT ALL ON TABLE "public"."health_score_snapshots" TO "anon";
GRANT ALL ON TABLE "public"."health_score_snapshots" TO "authenticated";
GRANT ALL ON TABLE "public"."health_score_snapshots" TO "service_role";
...
GRANT ALL ON TABLE "public"."knowledge_change_log" TO "service_role";
...
GRANT ALL ON TABLE "public"."owner_change_log_entries" TO "anon";
GRANT ALL ON TABLE "public"."owner_change_log_entries" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_change_log_entries" TO "service_role";



GRANT ALL ON TABLE "public"."owner_customer_ready_gates" TO "anon";
GRANT ALL ON TABLE "public"."owner_customer_ready_gates" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_customer_ready_gates" TO "service_role";



GRANT ALL ON TABLE "public"."owner_gus_validation_results" TO "anon";
GRANT ALL ON TABLE "public"."owner_gus_validation_results" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_gus_validation_results" TO "service_role";



GRANT ALL ON TABLE "public"."owner_gus_validation_test_cases" TO "anon";
GRANT ALL ON TABLE "public"."owner_gus_validation_test_cases" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_gus_validation_test_cases" TO "service_role";



GRANT ALL ON TABLE "public"."owner_manual_review_items" TO "anon";
GRANT ALL ON TABLE "public"."owner_manual_review_items" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_manual_review_items" TO "service_role";



GRANT ALL ON TABLE "public"."owner_registry" TO "anon";
GRANT ALL ON TABLE "public"."owner_registry" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_registry" TO "service_role";



GRANT ALL ON TABLE "public"."owner_validation_check_results" TO "anon";
GRANT ALL ON TABLE "public"."owner_validation_check_results" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_validation_check_results" TO "service_role";



GRANT ALL ON TABLE "public"."owner_validation_modules" TO "anon";
GRANT ALL ON TABLE "public"."owner_validation_modules" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_validation_modules" TO "service_role";



GRANT ALL ON TABLE "public"."owner_validation_runs" TO "anon";
GRANT ALL ON TABLE "public"."owner_validation_runs" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_validation_runs" TO "service_role";



GRANT ALL ON TABLE "public"."owner_validation_sandbox_records" TO "anon";
GRANT ALL ON TABLE "public"."owner_validation_sandbox_records" TO "authenticated";
GRANT ALL ON TABLE "public"."owner_validation_sandbox_records" TO "service_role";
...
GRANT ALL ON TABLE "public"."platform_help_tickets" TO "anon";
GRANT ALL ON TABLE "public"."platform_help_tickets" TO "authenticated";
GRANT ALL ON TABLE "public"."platform_help_tickets" TO "service_role";
...
GRANT ALL ON TABLE "public"."research_queue" TO "service_role";
GRANT SELECT ON TABLE "public"."research_queue" TO "authenticated";
