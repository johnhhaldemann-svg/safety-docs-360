-- Re-applies the induction schema under a unique migration version. The original
-- 20260425120000 file collided with an already-applied remote migration version.
