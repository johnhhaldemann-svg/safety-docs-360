...
Generated: 2026-05-28T15:29:28.064Z
...
- **healthy:** latest local migration is 20260527161114; latest remote migration is 20260527161114.
- **healthy:** 9 cron job(s) declared with no unresolved duplicate paths.
- **healthy:** intentional duplicate cron coverage: /api/cron/jobsite-daily-todos (0 10 * * *, 0 11 * * *) covers 5am America/Chicago across daylight and standard time; the route skips non-5am local invocations.
...
- Keep `/api/cron/jobsite-daily-todos` scheduled at both 10:00 UTC and 11:00 UTC unless the route stops enforcing the 5am America/Chicago local-hour guard.
