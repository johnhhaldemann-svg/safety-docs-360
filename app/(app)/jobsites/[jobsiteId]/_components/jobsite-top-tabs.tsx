...
export function JobsiteTopTabs({
  ...
  return (
    <div className="sticky top-0 z-20 rounded-2xl border border-slate-200 bg-white/95 p-3 backdrop-blur">
      <div className="mb-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">
        Jobsite Workspace
      </div>
      <div className="mb-2 text-xl font-black text-slate-900">Jobsite {jobsiteId}</div>
