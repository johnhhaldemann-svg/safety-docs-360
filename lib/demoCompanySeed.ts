    ...
    .upsert(
      {
        ...
        primary_contact_email: actorEmail || "demo@safety360docs.com",
        demo_company: true,
      ...
      .upsert(
        {
          ...
          account_email: "planner.demo@safety360docs.com",
      ...
      .insert([
        {
          ...
          owner_email: "jordan.demo@safety360docs.com",
        ...
        },
        {
          ...
          owner_email: "nora.demo@safety360docs.com",
          raw_payload: { demo: true },
          jobsite_id: jobsites.get("Hospital Expansion"),
          created_by: actorUserId,
          updated_by: actorUserId,
        },
        {
          ...
          owner_email: "eli.demo@safety360docs.com",
          raw_payload: { demo: true },
          jobsite_id: jobsites.get("Warehouse Buildout"),
          created_by: actorUserId,
          updated_by: actorUserId,
  ...
  await ignoreMissingSchema(
    table(supabase, "company_microsoft_project_assignments").insert(
      tasks.slice(0, 5).map((task, index) => ({
        ...
        email: `demo.worker.${index + 1}@safety360docs.com`,
        raw_payload: { demo: true },
        created_by: actorUserId,
        updated_by: actorUserId,
      }))
