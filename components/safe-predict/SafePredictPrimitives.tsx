...
function defaultSectionHint(title: string) {
  const hints: Record<string, string> = {
    ...
    "Risk Thresholds": "Defines how SafePredict groups numeric risk scores into low, medium, high, and critical bands.",
    "Connected SafePredict Workflows": "Links this SafePredict screen back to the connected operating workflows.",
