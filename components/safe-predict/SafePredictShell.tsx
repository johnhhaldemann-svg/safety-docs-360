...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/safe-predict/rca", label: "Root Cause Analysis", icon: GitBranch },
      { href: "/safe-predict/toolbox-talks", label: "Toolbox Talks", icon: BookOpen },
      { href: "/safe-predict/jsa", label: "JSA Builder", icon: Wrench },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/safe-predict/emergency-action-plan", label: "Emergency Action Plan", icon: ShieldCheck },
    ],
  },
  {
    id: "document-control",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/safe-predict/contractors", label: "Contractors", icon: Building2 },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/safe-predict/management-review", label: "Management Review", icon: PieChart },
      { href: "/safe-predict/lessons-learned", label: "Lessons Learned", icon: Lightbulb },
    ],
  },
  {
