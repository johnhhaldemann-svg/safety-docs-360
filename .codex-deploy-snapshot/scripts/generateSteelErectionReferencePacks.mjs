...
const TASK_CONFIGS = [
  ...
  },
  {
    ...
    triggerManifest: {
      ...
      subTradeKeywords: ["steel erection", "decking", "ironworker"],
      taskNames: ["embeds"],
      taskKeywords: ["embed", "insert plate", "sleeve", "cast-in"],
      taskAliases: ["steel embeds", "setting embeds"],
      pshsepScopeKeywords: ["steel erection", "structural steel"],
      highRiskKeywords: ["steel erection / rigging", "hot work / fire watch"],
      assumedTradeKeywords: ["steel erection", "ironwork"],
      exportProgramIds: ["steel_erection", "hot_work"],
  ...
  {
    filename: "Task_11_Punch_List_Closeout.docx",
    moduleKey: "steel_punch_list_and_closeout_remediation",
    title: "Punch List and Closeout Remediation (Steel)",
    subTrade: "Steel erection / decking",
    taskNames: ["Punch list"],
    triggerManifest: {
      tradeKeywords: ["steel", "ironwork", "structural steel"],
      subTradeKeywords: ["steel erection", "decking", "ironworker"],
      taskNames: ["punch list"],
      taskKeywords: ["punchlist", "closeout", "remediation"],
      taskAliases: ["steel punch", "punch list steel"],
      pshsepScopeKeywords: ["steel erection", "structural steel"],
      highRiskKeywords: ["steel erection / rigging", "hot work / fire watch"],
      assumedTradeKeywords: ["steel erection", "ironwork"],
      exportProgramIds: ["steel_erection", "hot_work"],
  ...
  {
    filename: "Task_12_Touch_Up_Painting.docx",
    moduleKey: "steel_touch_up_painting_on_structural_steel",
    title: "Touch-Up Painting on Structural Steel",
    subTrade: "Steel erection / decking",
    taskNames: ["Touch-up painting"],
    triggerManifest: {
      tradeKeywords: ["steel", "ironwork", "structural steel"],
      subTradeKeywords: ["steel erection", "decking", "ironworker"],
      taskNames: ["touch-up painting"],
      taskKeywords: ["touch-up", "touch up", "painting", "primer", "coating"],
      taskAliases: ["steel touch up", "field painting steel"],
      pshsepScopeKeywords: ["steel erection", "structural steel"],
      highRiskKeywords: ["steel erection / rigging", "hot work / fire watch"],
      assumedTradeKeywords: ["steel erection", "ironwork"],
      exportProgramIds: ["steel_erection", "hot_work"],
...
function renderHazardSource(records) {
  return `// Auto-generated by scripts/generateSteelErectionReferencePacks.mjs
