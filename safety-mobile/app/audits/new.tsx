...
const styles = StyleSheet.create({
  ...
  reviewBadge: { color: theme.warning, backgroundColor: theme.warningSoft, borderRadius: 999, overflow: "hidden", paddingHorizontal: 10, paddingVertical: 6, fontSize: 10, fontWeight: "900", textTransform: "uppercase" },
  scopeCount: { color: theme.accent, backgroundColor: theme.accentSoft, borderRadius: 999, overflow: "hidden", paddingHorizontal: 10, paddingVertical: 6, fontSize: 10, fontWeight: "900", textTransform: "uppercase" },
  dropdownButton: { minHeight: theme.tap, borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.surface, borderRadius: theme.radiusMd, paddingHorizontal: 13, paddingVertical: 13 },
  ...
  tradeRow: { minHeight: theme.tap, flexDirection: "row", alignItems: "center", gap: 10, borderWidth: 1, borderColor: theme.border, backgroundColor: theme.surface, borderRadius: theme.radiusMd, paddingHorizontal: 11, paddingVertical: 11 },
  ...
  scoreTitle: { color: theme.white, fontWeight: "900", fontSize: 18, lineHeight: 23, marginTop: 3 },
  ...
  progressTrack: { height: 8, borderRadius: 999, backgroundColor: "#21344d", overflow: "hidden" },
  progressFill: { height: 8, borderRadius: 999, backgroundColor: "#71a7ff" },
  scoreGrid: { flexDirection: "row", gap: 8 },
  metric: { flex: 1, borderWidth: 1, borderColor: "rgba(255,255,255,0.14)", backgroundColor: "rgba(255,255,255,0.08)", borderRadius: theme.radiusSm, padding: 10, gap: 2 },
  metricValue: { color: theme.white, fontSize: 19, fontWeight: "900" },
  metricDanger: { color: theme.danger },
  metricLabel: { color: "#cbd8e8", fontSize: 10, fontWeight: "900", textTransform: "uppercase" },
  section: { borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.primaryTint, borderRadius: theme.radiusLg, padding: 13, gap: 13 },
  ...
  sectionActionButton: { borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.surface, borderRadius: theme.radiusMd, paddingHorizontal: 10, paddingVertical: 9, alignItems: "center" },
  ...
  finalPage: { borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.surfaceRaised, borderRadius: theme.radiusLg, padding: 16, gap: 13 },
  ...
  item: { borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.surfaceRaised, borderRadius: theme.radiusLg, padding: 13, gap: 11 },
  ...
  statusButton: { flex: 1, minHeight: 44, borderWidth: 1, borderColor: theme.borderStrong, backgroundColor: theme.surface, borderRadius: theme.radiusMd, paddingVertical: 10, alignItems: "center", justifyContent: "center" },
