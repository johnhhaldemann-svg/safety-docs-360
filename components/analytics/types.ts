...
export type HealthIssueRecentItem = {
  id: string;
  title: string;
...
export type HealthIssueFocus = {
  injuryType: string;
  label: string;
  count: number;
  severityBands: { critical: number; high: number; medium: number; low: number; unspecified: number };
  recentItems: HealthIssueRecentItem[];
} | null;
...
export type AnalyticsSummary = {
  ...
  healthIssueRollup?: HealthIssueRollupItem[];
