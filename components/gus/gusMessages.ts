...
export const gusRouteMessages: RouteMessage[] = [
  ...
  },
  {
    ...
    message: {
      ...
      category: "planning",
      priority: 1,
      message: "JSAs should stay draft-only until a supervisor or safety lead checks the work plan.",
  ...
  },
  {
    ...
    message: {
      ...
      priority: 1,
      message: "Permit work needs a safety lead check. I can help spot missing permit details first.",
  ...
  },
  {
    ...
    message: {
      ...
      category: "risk_alert",
      priority: 1,
      message: "High-risk signals deserve a clear next safe step and safety lead check before work proceeds.",
      reason: "Critical or severe risk should trigger a field check and possible do-not-continue evaluation.",
      ...gusDefaultActions.openDashboard,
    },
  },
  {
