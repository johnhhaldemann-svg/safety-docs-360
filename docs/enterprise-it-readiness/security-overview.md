...
Scope: SafePredict application controls visible in the repository as of 2026-05-17. Hosted Supabase, Vercel, domain, logging-retention, legal, and backup claims need dashboard or owner confirmation before customer use.

| Claim | Status | Evidence | Review Notes |
| --- | --- | --- | --- |
| SafePredict is a Next.js application intended to run on Vercel. | Verified | [package.json](../../package.json), [vercel.json](../../vercel.json) | Confirm production project/team in Vercel dashboard. |
